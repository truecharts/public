...
(() => {
  ...
  var J = (t, e, r) =>
      e in t
        ...
        : (t[e] = r),
    M = (t, e) => {
      for (var r in e || (e = {})) X.call(e, r) && J(t, r, e[r]);
      if (G) for (var r of G(e)) Qe.call(e, r) && J(t, r, e[r]);
      return t;
    },
    Z = (t, e) => ye(t, ve(e));
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of xe(e))
        !X.call(t, i) &&
          ...
          W(t, i, {
            get: () => e[i],
            enumerable: !(n = me(e, i)) || n.enumerable,
          });
    return t;
  };
  var H = (t, e, r) => (
    ...
    be(
      e || !t || !t.__esModule
        ? W(r, "default", { value: t, enumerable: !0 })
        : r,
      t,
    )
  );
...
`,
       ...
       */ (t.stemmer = (function () {
        var e = {
          ...
          D = function (l) {
            ...
            if (
              ((E = l.substr(0, 1)),
              E == "y" && (l = E.toUpperCase() + l.substr(1)),
              (f = Q),
              (x = p),
              f.test(l)
                ? (l = l.replace(f, "$1$2"))
                : x.test(l) && (l = l.replace(x, "$1$2")),
              (f = d),
              (x = w),
              f.test(l))
            ) {
              var S = f.exec(l);
              (f = y), f.test(S[1]) && ((f = L), (l = l.replace(f, "")));
            } else if (x.test(l)) {
              var S = x.exec(l);
              (v = S[1]),
                (x = m),
            ...
            if (((f = A), f.test(l))) {
              var S = f.exec(l);
              (v = S[1]), (P = S[2]), (f = y), f.test(v) && (l = v + e[P]);
            }
            if (((f = N), f.test(l))) {
              var S = f.exec(l);
              (v = S[1]), (P = S[2]), (f = y), f.test(v) && (l = v + r[P]);
            }
            if (((f = C), (x = $), f.test(l))) {
              var S = f.exec(l);
              (v = S[1]), (f = g), f.test(v) && (l = v);
            } else if (x.test(l)) {
              var S = x.exec(l);
              (v = S[1] + S[2]), (x = g), x.test(v) && (l = v);
            }
            if (((f = T), f.test(l))) {
              var S = f.exec(l);
              (v = S[1]),
                ...
                (x = b),
                (R = B),
                (f.test(v) || (x.test(v) && !R.test(v))) && (l = v);
            }
            return (
              (f = V),
              (x = g),
              f.test(l) && x.test(l) && ((f = L), (l = l.replace(f, ""))),
              E == "y" && (l = E.toLowerCase() + l.substr(1)),
              l
            );
          };
        return function (O) {
          ...
          for (
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                ...
                y in s.node.edges
                  ? (g = s.node.edges[y])
                  : ((g = new t.TokenSet()), (s.node.edges[y] = g)),
                  s.str.length == 1 && (g.final = !0),
                  i.push({
                    node: g,
                    editsRemaining: s.editsRemaining - 1,
                    str: h + s.str.slice(2),
        ...
        (t.TokenSet.prototype.intersect = function (e) {
          for (
            ...
            for (
              ...
              for (var h = s[c], y = 0; y < u; y++) {
                var g = a[y];
                if (g == h || h == "*") {
                  var b = n.node.edges[g],
                    m = n.qNode.edges[h],
                    Q = b.final && m.final,
                    p = void 0;
                  g in n.output.edges
                    ? ((p = n.output.edges[g]), (p.final = p.final || Q))
                    : ((p = new t.TokenSet()),
                      (p.final = Q),
                      (n.output.edges[g] = p)),
                    i.push({ qNode: m, output: p, node: b });
                }
              }
          }
          return r;
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var u = 0; u < r.clauses.length; u++) {
            var c = r.clauses[u],
              ...
              y = t.Set.empty;
            c.usePipeline
              ? (h = this.pipeline.runString(c.term, { fields: c.fields }))
              : (h = [c.term]);
            for (var g = 0; g < h.length; g++) {
              var b = h[g];
              c.term = b;
              var m = t.TokenSet.fromClause(c),
                Q = this.tokenSet.intersect(m).toArray();
              if (Q.length === 0 && c.presence === t.Query.presence.REQUIRED) {
                for (var p = 0; p < c.fields.length; p++) {
                  var d = c.fields[p];
                  o[d] = t.Set.empty;
                }
                break;
              ...
              for (var w = 0; w < Q.length; w++)
                for (
                  var L = Q[w], k = this.invertedIndex[L], I = k._index, p = 0;
                  p < c.fields.length;
                  p++
                ) {
                  var d = c.fields[p],
                  ...
                  if (
                    (c.presence == t.Query.presence.REQUIRED &&
                      ((y = y.union(N)),
                      o[d] === void 0 && (o[d] = t.Set.complete)),
                    c.presence == t.Query.presence.PROHIBITED)
                  ) {
                    a[d] === void 0 && (a[d] = t.Set.empty),
                      (a[d] = a[d].union(N));
                    continue;
                  }
                  if (
                    (i[d].upsert(I, c.boost, function (pe, de) {
                      return pe + de;
                    }),
                    !s[A])
                  ) {
          ...
          for (
            var D = t.Set.complete, O = t.Set.empty, u = 0;
            u < this.fields.length;
            u++
          ) {
            var d = this.fields[u];
            o[d] && (D = D.intersect(o[d])), a[d] && (O = O.union(a[d]));
          }
          var l = Object.keys(n),
            v = [],
          ...
          if (r.isNegated()) {
            ...
            for (var u = 0; u < l.length; u++) {
              var T = l[u],
                E = t.FieldRef.fromString(T);
              n[T] = new t.MatchData();
            }
          }
          for (var u = 0; u < l.length; u++) {
            var E = t.FieldRef.fromString(l[u]),
              f = E.docRef;
            if (!!D.contains(f) && !O.contains(f)) {
              var x = this.fieldVectors[E],
                R = i[E.fieldName].similarity(x),
                _;
              if ((_ = P[f]) !== void 0)
                (_.score += R), _.matchData.combine(n[E]);
              else {
                var S = { ref: f, score: R, matchData: n[E] };
                (P[f] = S), v.push(S);
              }
            }
          }
          return v.sort(function (he, fe) {
            return fe.score - he.score;
          });
        }),
        ...
        (t.Builder.prototype.add = function (e, r) {
          ...
          for (var s = 0; s < i.length; s++) {
            var o = i[s],
              ...
              u = a ? a(e) : e[o],
              c = this.tokenizer(u, { fields: [o] }),
              h = this.pipeline.run(c),
              y = new t.FieldRef(n, o),
              g = Object.create(null);
            (this.fieldTermFrequencies[y] = g),
              (this.fieldLengths[y] = 0),
              (this.fieldLengths[y] += h.length);
            for (var b = 0; b < h.length; b++) {
              var m = h[b];
              if (
                (g[m] == null && (g[m] = 0),
                (g[m] += 1),
                this.invertedIndex[m] == null)
              ) {
                var Q = Object.create(null);
                (Q._index = this.termIndex), (this.termIndex += 1);
                for (var p = 0; p < i.length; p++)
                  Q[i[p]] = Object.create(null);
                this.invertedIndex[m] = Q;
              }
              this.invertedIndex[m][o][n] == null &&
                (this.invertedIndex[m][o][n] = Object.create(null));
              for (var d = 0; d < this.metadataWhitelist.length; d++) {
                var w = this.metadataWhitelist[d],
                  L = m.metadata[w];
                this.invertedIndex[m][o][n][w] == null &&
                  (this.invertedIndex[m][o][n][w] = []),
                  this.invertedIndex[m][o][n][w].push(L);
              }
            }
          }
        }),
          ...
          for (
            ...
            for (
              var o = t.FieldRef.fromString(r[s]),
                ...
                m = this._documents[o.docRef].boost || 1,
                Q = 0;
              Q < g;
              Q++
            ) {
              var p = y[Q],
                d = h[p],
                w = this.invertedIndex[p]._index,
                L,
                k,
                I;
              i[p] === void 0
                ? ((L = t.idf(this.invertedIndex[p], this.documentCount)),
                  (i[p] = L))
                : (L = i[p]),
                (k =
                  (L * ((this._k1 + 1) * d)) /
  ...
  var q = K((Re, ne) => {
    ...
    function we(t) {
      ...
      for (s = r.index; s < e.length; s++) {
        ...
        o !== s && (i += e.substring(o, s)), (o = s + 1), (i += n);
      }
  ...
  typeof Element != "undefined" &&
    (Element.prototype.scrollTo ||
      (Element.prototype.scrollTo = function (t, e) {
        typeof t == "object"
          ? ((this.scrollLeft = t.left), (this.scrollTop = t.top))
          : ((this.scrollLeft = t), (this.scrollTop = e));
      }),
    Element.prototype.replaceWith ||
      (Element.prototype.replaceWith = function (...t) {
  ...
  function se(t) {
    let e = new Map(),
      r = new Set();
    for (let n of t) {
      let [i, s] = n.location.split("#"),
        o = n.location,
        a = n.title,
        u = n.tags,
        c = (0, ie.default)(n.text)
          .replace(/\s+(?=[,.:;!?])/g, "")
          .replace(/\s+/g, " ");
      if (s) {
        let h = e.get(i);
        r.has(h)
          ? e.set(o, { location: o, title: a, text: c, parent: h })
          : ((h.title = n.title), (h.text = c), r.add(h));
      } else e.set(o, M({ location: o, title: a, text: c }, u && { tags: u }));
    }
    return e;
  }
  var oe = H(q());
  function ae(t, e) {
    let r = new RegExp(t.separator, "img"),
      n = (i, s, o) => `${s}<mark data-md-highlight>${o}</mark>`;
    return (i) => {
  ...
  function ue(t) {
    let e = new lunr.Query(["title", "text"]);
    return new lunr.QueryParser(t, e).parse(), e.clauses;
  }
  function ce(t, e) {
    var i;
    let r = new Set(t),
    ...
    for (let s = 0; s < e.length; s++)
      for (let o of r)
        e[s].startsWith(o.term) && ((n[o.term] = !0), r.delete(o));
    for (let s of r)
      (i = lunr.stopWordFilter) != null &&
        i.call(lunr, s.term) &&
        (n[s.term] = !1);
    return n;
  }
  ...
  var U = class {
    constructor({ config: e, docs: r, options: n }) {
      (this.options = n),
        (this.documents = se(r)),
        (this.highlight = ae(e, !1)),
        (lunr.tokenizer.separator = new RegExp(e.separator)),
        (this.index = lunr(function () {
          e.lang.length === 1 && e.lang[0] !== "en"
            ? this.use(lunr[e.lang[0]])
            : e.lang.length > 1 && this.use(lunr.multiLanguage(...e.lang));
          let i = Ee(["trimmer", "stopWordFilter", "stemmer"], n.pipeline);
          for (let s of e.lang.map((o) => (o === "en" ? lunr : lunr[o])))
            for (let o of i)
              this.pipeline.remove(s[o]), this.searchPipeline.remove(s[o]);
          this.ref("location"),
            ...
            this.field("tags", {
              ...
              extractor: (s) => {
                let { tags: o = [] } = s;
                return o.reduce((a, u) => [...a, ...lunr.tokenizer(u)], []);
              },
            });
          for (let s of r) this.add(s, { boost: s.boost });
        }));
    }
    search(e) {
      if (e)
        try {
          let r = this.highlight(e),
            n = ue(e).filter(
              (o) => o.presence !== lunr.Query.presence.PROHIBITED,
            ),
            i = this.index
              .search(`${e}*`)
              .reduce((o, { ref: a, score: u, matchData: c }) => {
                let h = this.documents.get(a);
                if (typeof h != "undefined") {
                  let {
                    ...
                    p = ce(n, Object.keys(c.metadata)),
                    d = +!Q + +Object.values(p).every((w) => w);
                  o.push(
                    Z(
                      M(
                        { location: y, title: r(g), text: r(b) },
                        m && { tags: m.map(r) },
                      ),
                      { score: u * (1 + d), terms: p },
                    ),
              ...
              .reduce((o, a) => {
                let u = this.documents.get(a.location);
                if (typeof u != "undefined") {
                  let c = "parent" in u ? u.parent.location : u.location;
                  o.set(c, [...(o.get(c) || []), a]);
                }
                return o;
              }, new Map()),
          ...
          if (this.options.suggestions) {
            ...
            s = o.length ? Object.keys(o[0].matchData.metadata) : [];
          }
          return M(
            { items: [...i.values()] },
            typeof s != "undefined" && { suggestions: s },
          );
        } catch (r) {
          console.warn(`Invalid query: ${e} \u2013 see https://bit.ly/2s3ChXG`);
        }
      return { items: [] };
    }
  };
  ...
  function ke(t) {
    return z(this, null, function* () {
      ...
      if (typeof parent != "undefined" && "IFrameWorker" in parent) {
        let n = document.querySelector("script[src]"),
      ...
      t.lang.length > 1 && r.push(`${e}/min/lunr.multi.min.js`),
        r.length &&
          (yield importScripts(`${e}/min/lunr.stemmer.support.min.js`, ...r));
    });
  }
  function Te(t) {
    return z(this, null, function* () {
      switch (t.type) {
        case 0:
          return yield ke(t.data.config), (Y = new U(t.data)), { type: 1 };
        case 2:
          return { type: 3, data: Y ? Y.search(t.data) : { items: [] } };
        default:
          throw new TypeError("Invalid message type");
      }
    });
  }
  self.lunr = le.default;
  addEventListener("message", (t) =>
    z(void 0, null, function* () {
      postMessage(yield Te(t.data));
    }),
  );
})();
