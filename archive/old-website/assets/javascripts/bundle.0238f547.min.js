...
(() => {
  ...
  var an = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    U = (e, t) => {
      for (var r in t || (t = {})) Sr.call(t, r) && an(e, r, t[r]);
      if (kt) for (var r of kt(t)) sn.call(t, r) && an(e, r, t[r]);
      return e;
    };
  var cn = (e, t) => {
    var r = {};
    for (var n in e) Sr.call(e, n) && t.indexOf(n) < 0 && (r[n] = e[n]);
    if (e != null && kt)
      for (var n of kt(e)) t.indexOf(n) < 0 && sn.call(e, n) && (r[n] = e[n]);
    return r;
  };
  var gt = (e, t) => () => (
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let o of oa(t))
        !Sr.call(e, o) &&
          ...
          xr(e, o, {
            get: () => t[o],
            enumerable: !(n = na(t, o)) || n.enumerable,
          });
    return e;
  };
  var Ye = (e, t, r) => (
  ...
  var un = gt((wr, fn) => {
    (function (e, t) {
      typeof wr == "object" && typeof fn != "undefined"
        ? t()
      ...
      function e(r) {
        ...
        function c(w) {
          var Ue = w.type,
            He = w.tagName;
          return !!(
            (He === "INPUT" && a[Ue] && !w.readOnly) ||
            (He === "TEXTAREA" && !w.readOnly) ||
            w.isContentEditable
          );
        }
        function f(w) {
          w.classList.contains("focus-visible") ||
            (w.classList.add("focus-visible"),
            w.setAttribute("data-focus-visible-added", ""));
        }
        function u(w) {
          !w.hasAttribute("data-focus-visible-added") ||
            (w.classList.remove("focus-visible"),
        ...
        function h(w) {
          !s(w.target) ||
            ((w.target.classList.contains("focus-visible") ||
              w.target.hasAttribute("data-focus-visible-added")) &&
              ((o = !0),
  ...
  var pn = gt((Er) => {
    (function (e) {
      var t = function () {
        ...
        a = function () {
          var f = function (p) {
              ...
              var l = typeof p;
              if (l !== "undefined")
                if (l === "string") p !== "" && this._fromString(p);
                else if (p instanceof f) {
                  var d = this;
                  p.forEach(function (G, W) {
                    d.append(W, G);
                  });
            ...
            (u.forEach = function (p, l) {
              ...
              for (var h in this._entries)
                if (this._entries.hasOwnProperty(h)) {
                  d = this._entries[h];
                  for (var b = 0; b < d.length; b++) p.call(l, d[b], h, this);
                }
            }),
            (u.keys = function () {
              var p = [];
        ...
        s = function () {
          try {
            ...
            return (
              new f("?a=1").toString() === "a=1" &&
              typeof f.prototype.set == "function" &&
              typeof f.prototype.entries == "function"
            );
          } catch (u) {
            return !1;
          }
      ...
      typeof c.sort != "function" &&
        (c.sort = function () {
          var f = this,
            u = [];
          this.forEach(function (l, d) {
            u.push([d, l]), f._entries || f.delete(d);
          }),
            u.sort(function (l, d) {
              return l[0] < d[0] ? -1 : l[0] > d[0] ? 1 : 0;
            }),
            f._entries && (f._entries = {});
          for (var p = 0; p < u.length; p++) this.append(u[p][0], u[p][1]);
        }),
        typeof c._fromString != "function" &&
          Object.defineProperty(c, "_fromString", {
            ...
            value: function (f) {
              if (this._entries) this._entries = {};
                ...
                for (var p = 0; p < u.length; p++) this.delete(u[p]);
              }
              f = f.replace(/^\?/, "");
        ...
        r = function () {
          var o = e.URL,
            i = function (c, f) {
              ...
              if (f && (e.location === void 0 || f !== e.location.href)) {
                ...
                try {
                  if (p.href.indexOf(f) !== 0) throw new Error(p.href);
                } catch (w) {
                  throw new Error(
                    "URL unable to set base " + f + " due to " + w,
                  );
                }
              }
              var l = u.createElement("a");
              (l.href = c), p && (u.body.appendChild(l), (l.href = l.href));
              ...
              ["append", "delete", "set"].forEach(function (w) {
                var Ue = h[w];
                h[w] = function () {
                  Ue.apply(h, arguments),
                    b && ((F = !1), (G.search = h.toString()), (F = !0));
                };
              }),
          ...
          ["hash", "host", "hostname", "port", "protocol"].forEach(
            ...
            Object.defineProperties(a, {
              ...
              origin: {
                get: function () {
                  var c = { "http:": 80, "https:": 443, "ftp:": 21 }[
                      this._anchorElement.protocol
                    ],
                    f =
                      this._anchorElement.port != c &&
                      this._anchorElement.port !== "";
                  return (
                    this._anchorElement.protocol +
                    "//" +
                    this._anchorElement.hostname +
                    (f ? ":" + this._anchorElement.port : "")
                  );
                },
                enumerable: !0,
              },
...
***************************************************************************** */ var ln,
    ...
    (function (e) {
      ...
      typeof define == "function" && define.amd
        ...
        : typeof It == "object" && typeof It.exports == "object"
          ? e(r(t, r(It.exports)))
          : e(r(t));
      function r(n, o) {
        return (
      ...
      (ln = function (n, o) {
        ...
        (dn = function (n, o) {
          ...
          if (n != null && typeof Object.getOwnPropertySymbols == "function")
            for (
              var s = 0, a = Object.getOwnPropertySymbols(n);
              s < a.length;
              s++
            )
              o.indexOf(a[s]) < 0 &&
                Object.prototype.propertyIsEnumerable.call(n, a[s]) &&
                (i[a[s]] = n[a[s]]);
          return i;
        }),
        (hn = function (n, o, i, a) {
          ...
          if (
            ...
            c = Reflect.decorate(n, o, i, a);
          else
            for (var u = n.length - 1; u >= 0; u--)
              (f = n[u]) &&
                (c = (s < 3 ? f(c) : s > 3 ? f(o, i, c) : f(o, i)) || c);
          return s > 3 && c && Object.defineProperty(o, i, c), c;
        }),
        (bn = function (n, o) {
          return function (i, a) {
            o(i, a, n);
        ...
        (gn = function (n, o, i, a) {
          ...
          return new (i || (i = Promise))(function (c, f) {
            ...
            function l(d) {
              d.done ? c(d.value) : s(d.value).then(u, p);
            }
        ...
        (yn = function (n, o) {
          var i = {
            ...
            f;
          return (
            (f = { next: u(0), throw: u(1), return: u(2) }),
              ...
              try {
                ...
                switch (((s = 0), c && (l = [l[0] & 2, c.value]), l[0])) {
                  ...
                  default:
                    ...
                    if (l[0] === 6 && i.label < c[1]) {
                      (i.label = c[1]), (c = l);
                      break;
                    }
                    if (c && i.label < c[2]) {
                      (i.label = c[2]), i.ops.push(l);
                      break;
                    }
        ...
        (wn = function () {
          ...
          for (var a = Array(n), s = 0, o = 0; o < i; o++)
            for (var c = arguments[o], f = 0, u = c.length; f < u; f++, s++)
              a[s] = c[f];
          return a;
        }),
        (En = function (n, o, i) {
          if (i || arguments.length === 2)
            for (var a = 0, s = o.length, c; a < s; a++)
              (c || !(a in o)) &&
                (c || (c = Array.prototype.slice.call(o, 0, a)), (c[a] = o[a]));
        ...
        (On = function (n, o, i) {
          ...
          function p(b) {
            b.value instanceof tt
              ? Promise.resolve(b.value.v).then(l, d)
              : h(c[0][2], b);
          }
          function l(b) {
            u("next", b);
          ...
          function h(b, F) {
            b(F), c.shift(), c.length && u(c[0][0], c[0][1]);
          }
        }),
        (_n = function (n) {
          var o, i;
        ...
        (Tn = function (n) {
          ...
          return o
            ? o.call(n)
            : ((n = typeof Ht == "function" ? Ht(n) : n[Symbol.iterator]()),
              (i = {}),
              a("next"),
              a("throw"),
              a("return"),
      ...
      (Ln = function (n) {
        ...
        e("__spreadArray", En),
        e("__await", tt),
        e("__asyncGenerator", On),
        e("__asyncDelegator", _n),
        e("__asyncValues", Tn),
        e("__makeTemplateObject", Mn),
        e("__importStar", Ln),
        e("__importDefault", An),
        e("__classPrivateFieldGet", Cn),
        e("__classPrivateFieldSet", Rn);
    });
  });
  var Kr = gt((Lt, Yr) => {
    /*!
     ...
     */ (function (t, r) {
      typeof Lt == "object" && typeof Yr == "object"
        ? (Yr.exports = r())
        : typeof define == "function" && define.amd
          ? define([], r)
          : typeof Lt == "object"
        ...
        var e = {
            686: function (n, o, i) {
              ...
              var d = function (E) {
                ...
                h = d;
              function b(I) {
                var E = document.documentElement.getAttribute("dir") === "rtl",
              ...
              var Ue = function () {
                  ...
                  if (z !== void 0)
                    if (z && w(z) === "object" && z.nodeType === 1) {
                      if (R === "copy" && z.hasAttribute("disabled"))
                        throw new Error(
                          'Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute',
                        );
                      if (
                        R === "cut" &&
                        (z.hasAttribute("readonly") ||
                  ...
                  if (Oe) return W(Oe, { container: H });
                  if (z) return R === "cut" ? h(z) : W(z, { container: H });
                },
                He = Ue;
              function Ce(I) {
                return (
              ...
              function Ki(I, E, S) {
                return E && on(I.prototype, E), S && on(I, S), I;
              }
              function Bi(I, E) {
              ...
              function Gi(I) {
                ...
                return function () {
                  var R = Ct(I),
                    H;
                  if (E) {
                    var z = Ct(this).constructor;
                    H = Reflect.construct(R, arguments, z);
                  } else H = R.apply(this, arguments);
                  return Ji(this, H);
                };
              }
              function Ji(I, E) {
                return E && (Ce(E) === "object" || typeof E == "function")
                  ? E
                  : Xi(I);
              }
              function Xi(I) {
                    ...
                    Ki(
                      ...
                      [
                            ...
                            (this.action =
                              ...
                              (this.target =
                                typeof H.target == "function"
                                  ...
                                  : this.defaultTarget),
                              (this.text =
                                typeof H.text == "function"
                                  ? H.text
                                  : this.defaultText),
                              (this.container =
                                Ce(H.container) === "object"
                                  ? H.container
                                  : document.body);
                          },
                        },
                        {
                          ...
                          value: function (H) {
                            var z = this;
                            this.listener = f()(H, "click", function (Oe) {
                              return z.onClick(Oe);
                            });
                          },
                        },
                        {
                          key: "onClick",
                          value: function (H) {
                            var z = H.delegateTarget || H.currentTarget,
                              Oe = this.action(z) || "copy",
                              Rt = He({
                                action: Oe,
                          ...
                          value: function () {
                            var H =
                                arguments.length > 0 && arguments[0] !== void 0
                                  ? arguments[0]
                                  : ["copy", "cut"],
                              z = typeof H == "string" ? [H] : H,
                              Oe = !!document.queryCommandSupported;
                            return (
                              z.forEach(function (Rt) {
                                Oe = Oe && !!document.queryCommandSupported(Rt);
                              }),
                              Oe
                            );
                          },
            ...
            828: function (n) {
              ...
              function a(s, c) {
                for (; s && s.nodeType !== o; ) {
                  if (typeof s.matches == "function" && s.matches(c)) return s;
                  s = s.parentNode;
                }
              }
              n.exports = a;
            ...
            438: function (n, o, i) {
              ...
              function c(u, p, l, d, h) {
                return typeof u.addEventListener == "function"
                  ? s.apply(null, arguments)
                  : typeof l == "function"
                    ? s.bind(null, document).apply(null, arguments)
                    : (typeof u == "string" &&
                        (u = document.querySelectorAll(u)),
                      Array.prototype.map.call(u, function (b) {
                        return s(b, p, l, d, h);
                      }));
              }
              function f(u, p, l, d) {
            ...
            370: function (n, o, i) {
              ...
              function c(l, d, h) {
                ...
                if (a.node(l)) return f(l, d, h);
                if (a.nodeList(l)) return u(l, d, h);
                if (a.string(l)) return p(l, d, h);
                throw new TypeError(
            ...
            279: function (n) {
              ...
              (o.prototype = {
                on: function (i, a, s) {
                  var c = this.e || (this.e = {});
                  return (c[i] || (c[i] = [])).push({ fn: a, ctx: s }), this;
                },
                once: function (i, a, s) {
                  var c = this;
                  function f() {
                    c.off(i, f), a.apply(s, arguments);
                  }
                ...
                emit: function (i) {
                  var a = [].slice.call(arguments, 1),
                    ...
                    c = 0,
                    f = s.length;
                  for (c; c < f; c++) s[c].fn.apply(s[c].ctx, a);
                  return this;
                },
                off: function (i, a) {
                  var s = this.e || (this.e = {}),
                  ...
                  if (c && a)
                    for (var u = 0, p = c.length; u < p; u++)
                      c[u].fn !== a && c[u].fn._ !== a && f.push(c[u]);
  ...
  var Hn = Ye(kn(), 1),
    {
      ...
      __asyncDelegator: Gs,
      __asyncValues: $n,
      __makeTemplateObject: Js,
      __importStar: Xs,
      __importDefault: Zs,
      __classPrivateFieldGet: ec,
      __classPrivateFieldSet: tc,
    } = Hn.default;
  function T(e) {
...
` +
  ...
  var Re = (function () {
    ...
    return (
        ...
        if (!this.closed) {
          ...
          if (T(u))
            try {
              ...
              i = b instanceof Ut ? b.errors : [b];
            }
          var p = this._finalizers;
          if (p) {
            this._finalizers = null;
            try {
              for (var l = be(p), d = l.next(); !d.done; d = l.next()) {
                var h = d.value;
                try {
                  jn(h);
                } catch (b) {
      ...
      (e.prototype._removeParent = function (t) {
        var r = this._parentage;
        r === t ? (this._parentage = null) : Array.isArray(r) && Pe(r, t);
      }),
      (e.prototype.remove = function (t) {
        var r = this._finalizers;
        r && Pe(r, t), t instanceof e && t._removeParent(this);
      }),
      (e.EMPTY = (function () {
        var t = new e();
        return (t.closed = !0), t;
  ...
  var rt = {
    setTimeout: function (e, t) {
      ...
      return o != null && o.setTimeout
        ? o.setTimeout.apply(o, V([e, t], D(r)))
        : setTimeout.apply(void 0, V([e, t], D(r)));
    },
  ...
  var Ke = null;
  function nt(e) {
    if (_e.useDeprecatedSynchronousErrorHandling) {
      var t = !Ke;
      if ((t && (Ke = { errorThrown: !1, error: null }), e(), t)) {
        var r = Ke,
          n = r.errorThrown,
          o = r.error;
        if (((Ke = null), n)) throw o;
      }
    } else e();
  }
  function Wn(e) {
  ...
  var yt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (n.isStopped = !1),
        r ? ((n.destination = r), Dt(r) && r.add(n)) : (n.destination = ua),
        n
      );
    }
    return (
      ...
      (t.prototype.next = function (r) {
        this.isStopped ? Lr(Dn(r), this) : this._next(r);
      }),
  ...
  var ca = (function () {
    ...
    ot = (function (e) {
      ...
      function t(r, n, o) {
        ...
        return (i.destination = new ca(a)), i;
      }
      return t;
    })(yt);
  function Vt(e) {
    _e.useDeprecatedSynchronousErrorHandling ? Wn(e) : Wt(e);
  }
  function fa(e) {
    throw e;
  }
  function Lr(e, t) {
    var r = _e.onStoppedNotification;
    r &&
      rt.setTimeout(function () {
        return r(e, t);
      });
  }
  var ua = { closed: !0, next: le, error: fa, complete: le };
  var it = (function () {
  ...
  function Nn(e) {
    var t;
    return (t = e != null ? e : _e.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function pa(e) {
  ...
  function la(e) {
    return (e && e instanceof yt) || (pa(e) && Dt(e));
  }
  function ma(e) {
      ...
      (t.prototype._innerSubscribe = function (r) {
        ...
        return i || a
          ...
          : ((this.currentObservers = null),
            s.push(r),
            new Re(function () {
              (n.currentObservers = null), Pe(s, r);
            }));
      }),
    ...
    return (
      ...
      (t.prototype._trimBuffer = function () {
        ...
        if ((n < 1 / 0 && s < i.length && i.splice(0, i.length - s), !a)) {
          for (var c = o.now(), f = 0, u = 1; u < i.length && i[u] <= c; u += 2)
            f = u;
          f && i.splice(0, f + 1);
        }
      }),
  ...
  var wt = {
    setInterval: function (e, t) {
      ...
      return o != null && o.setInterval
        ? o.setInterval.apply(o, V([e, t], D(r)))
        : setInterval.apply(void 0, V([e, t], D(r)));
    },
    ...
    return (
      (t.prototype.schedule = function (r, n) {
        ...
        return (
          ...
          (this.pending = !0),
          (this.delay = n),
          (this.id = this.id || this.requestAsyncId(i, this.id, n)),
          this
        );
      }),
      (t.prototype.requestAsyncId = function (r, n, o) {
        return (
          o === void 0 && (o = 0), wt.setInterval(r.flush.bind(r, this), o)
        );
      }),
    ...
    return (
      (t.prototype.requestAsyncId = function (r, n, o) {
        return (
          ...
          o !== null && o > 0
            ...
            : (r.actions.push(this),
              r._scheduled ||
                (r._scheduled = at.requestAnimationFrame(function () {
      ...
      (t.prototype.recycleAsyncId = function (r, n, o) {
        ...
        r.actions.some(function (i) {
          return i.id === n;
        }) || (at.cancelAnimationFrame(n), (r._scheduled = void 0));
      }),
      t
    );
  })(Nt);
  ...
  function De(e) {
    return T(kr(e)) ? e.pop() : void 0;
  }
  function ye(e) {
    return qt(kr(e)) ? e.pop() : void 0;
  }
  function Qt(e, t) {
  ...
  function Bt(e) {
    return (
      Symbol.asyncIterator && T(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function Gt(e) {
  ...
  function Sa(e, t) {
    ...
    return Pn(this, void 0, void 0, function () {
      ...
      return $t(this, function (c) {
        switch (c.label) {
          case 0:
            c.trys.push([0, 5, 6, 11]), (r = $n(e)), (c.label = 1);
          case 1:
            return [4, r.next()];
          case 2:
          ...
          case 4:
            return [3, 11];
          case 5:
            return (s = c.sent()), (o = { error: s }), [3, 11];
          case 6:
            return (
              c.trys.push([6, , 9, 10]),
  ...
  function to(e, t) {
    if (e != null) {
      if (Kt(e)) return Gn(e, t);
      if (st(e)) return Xn(e, t);
      if (Yt(e)) return Jn(e, t);
      if (Bt(e)) return tr(e, t);
      if (Xt(e)) return Zn(e, t);
      if (er(e)) return eo(e, t);
    }
    throw Gt(e);
  }
  function ie(e, t) {
  ...
  function Ea(e, t) {
    return wa(t) ? e.apply(void 0, V([], D(t))) : e(t);
  }
  function We(e) {
    return m(function (t) {
      return Ea(e, t);
  ...
  function no(e) {
    if (e.length === 1) {
      var t = e[0];
      if (Oa(t)) return { args: t, keys: null };
      if (La(t)) {
        var r = Ma(t);
        return {
  ...
  function La(e) {
    return e && typeof e == "object" && _a(e) === Ta;
  }
  function oo(e, t) {
  ...
  var Aa = ["addListener", "removeListener"],
    Ca = ["addEventListener", "removeEventListener"],
    Ra = ["on", "off"];
  function g(e, t, r, n) {
    if ((T(r) && ((n = r), (r = void 0)), n)) return g(e, t, r).pipe(We(n));
    var o = D(
        Pa(e)
          ? Ca.map(function (s) {
              return function (c) {
    ...
    return new $(function (s) {
      var c = function () {
        ...
        return s.next(1 < f.length ? f : f[0]);
      };
      return (
        i(c),
        function () {
  ...
  function Ve(e, t, r) {
    e === void 0 && (e = 0), r === void 0 && (r = Rr);
    var n = -1;
    return (
      t != null && (qt(t) ? (r = t) : (n = t)),
      new $(function (o) {
        var i = ro(e) ? +e - r.now() : e;
        i < 0 && (i = 0);
        var a = 0;
  ...
  function A() {
    ...
    var r = ye(e),
      n = Qt(e, 1 / 0),
      o = e;
    return o.length ? (o.length === 1 ? N(o[0]) : ct(n)(ie(o, r))) : k;
  }
  var xe = new $(le);
  var Ia = Array.isArray;
  function ft(e) {
    return e.length === 1 && Ia(e[0]) ? e[0] : e;
  }
  function M(e, t) {
    return v(function (r, n) {
      var o = 0;
                  ...
                  y(
                    ...
                    function (u) {
                      if (
                        ...
                        o.next(r ? r.apply(void 0, V([], D(p))) : p),
                          i.some(function (l, d) {
                            return !l.length && a[d];
                          }) && o.complete();
                      }
    ...
    return v(function (t, r) {
      ...
      t.subscribe(
        y(
          r,
          function (f) {
            (n = !0), (o = f), i || N(e(f)).subscribe((i = y(r, s, c)));
          },
          function () {
        ...
        r.subscribe(
          y(
            ...
            function (a) {
              ...
              i++ % t === 0 && o.push([]);
              try {
                for (var l = be(o), d = l.next(); !d.done; d = l.next()) {
                  var h = d.value;
                  h.push(a),
              ...
              if (p)
                try {
                  for (var b = be(p), F = b.next(); !F.done; F = b.next()) {
                    var h = F.value;
                    Pe(o, h), n.next(h);
                  }
                } catch (G) {
            ...
            function () {
              var a, s;
              try {
                for (var c = be(o), f = c.next(); !f.done; f = c.next()) {
                  var u = f.value;
                  n.next(u);
                }
              } catch (p) {
  ...
  function Je() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return Pr.apply(void 0, V([], D(e)));
  }
  function Ir(e, t) {
    return T(t) ? se(e, t, 1) : se(e, 1);
  }
  function Xe(e, t) {
    return (
      t === void 0 && (t = ue),
      v(function (r, n) {
        ...
        function c() {
          var f = a + e,
            u = t.now();
          if (u < f) {
            (o = this.schedule(void 0, f - u)), n.add(o);
            return;
          }
          s();
        }
        r.subscribe(
          y(
            n,
            function (f) {
              (i = f), (a = t.now()), o || ((o = t.schedule(c, e)), n.add(o));
            },
            function () {
              s(), n.complete();
            },
  ...
  function $r(e, t) {
    return t
      ? function (r) {
          return Ge(t.pipe(re(1), po()), r.pipe($r(e)));
        }
      : se(function (r, n) {
          return e(r, n).pipe(re(1), lo(r));
        });
  }
  function Fe(e, t) {
    t === void 0 && (t = ue);
  ...
  function jr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return function (r) {
      return Ge(r, P.apply(void 0, V([], D(e))));
    };
  }
  function C(e) {
    return v(function (t, r) {
  ...
  function mo() {
    ...
    return (
      (e = ft(e)),
      v(function (o, i) {
        ct(n)(ie(V([o], D(e)), r)).subscribe(i);
      })
    );
  }
  function Ze() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return mo.apply(void 0, V([], D(e)));
  }
  function _t(e) {
    var t,
      r = 1 / 0,
            ...
            var a = 0,
              ...
              c = function () {
                if ((s == null || s.unsubscribe(), (s = null), n != null)) {
                  var u = typeof n == "number" ? Ve(n) : N(n(a)),
                    p = y(i, function () {
                      p.unsubscribe(), f();
                    });
                  u.subscribe(p);
  ...
  function Fr(e, t) {
    return v(uo(e, t, arguments.length >= 2, !0));
  }
  function ne(e) {
    e === void 0 && (e = {});
    var t = e.connector,
        ...
        Ue.add(function () {
          ...
          u ||
            ((u = new ot({
              ...
              error: function (Ce) {
                (b = !0), F(), (p = Ur(G, o, Ce)), He.error(Ce);
              },
              complete: function () {
                (h = !0), F(), (p = Ur(G, a)), He.complete();
              },
            })),
            ie(w).subscribe(u));
      })(f);
  ...
  function O(e, t, r) {
    var n = T(e) || t || r ? { next: e, error: t, complete: r } : e;
    return n
      ? v(function (o, i) {
          var a;
          ...
          o.subscribe(
            y(
              ...
              function (c) {
                var f;
                (f = n.next) === null || f === void 0 || f.call(n, c),
                  i.next(c);
              },
              function () {
                var c;
              ...
              function (c) {
                var f;
                (s = !1),
                  (f = n.error) === null || f === void 0 || f.call(n, c),
                  i.error(c);
              },
              function () {
                var c, f;
                s &&
                  ((c = n.unsubscribe) === null || c === void 0 || c.call(n)),
    ...
    return (
      ...
      v(function (r, n) {
        var o = t.leading,
          ...
          l = function (h) {
            return (c = N(e(h)).subscribe(y(n, u, p)));
          },
          d = function () {
            if (a) {
              a = !1;
              var h = s;
              (s = null), n.next(h), !f && l(h);
            }
          };
        r.subscribe(
          y(
            n,
            function (h) {
              (a = !0), (s = h), !(c && !c.closed) && (o ? d() : l(h));
            },
            function () {
              (f = !0), !(i && a && c && !c.closed) && n.complete();
            },
          ),
        );
      })
    ...
    return v(function (n, o) {
      ...
      n.subscribe(
        y(o, function (p) {
          if (c) {
            var l = V([p], D(a));
            o.next(r ? r.apply(void 0, V([], D(l))) : l);
          }
        }),
      );
    });
  ...
  function ho() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return v(function (r, n) {
      Ot.apply(void 0, V([r], D(e))).subscribe(n);
    });
  }
  function Nr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return ho.apply(void 0, V([], D(e)));
  }
  function bo() {
    let e = new St(1);
    return (
      g(document, "DOMContentLoaded", { once: !0 }).subscribe(() =>
        e.next(document),
      ),
      e
    );
  ...
  function nr(e) {
    return A(g(document.body, "focusin"), g(document.body, "focusout")).pipe(
      Xe(1),
      m(() => {
        let t = Ne();
  ...
  function vo(e) {
    return A(g(window, "load"), g(window, "resize")).pipe(
      $e(0, Te),
      m(() => ze(e)),
      q(ze(e)),
    );
  ...
  function pt(e) {
    return A(g(e, "scroll"), g(window, "resize")).pipe(
      $e(0, Te),
      m(() => or(e)),
      q(or(e)),
    );
  ...
  var Da = 20,
    ...
    Va = typeof MutationObserver != "undefined",
    Na = (function () {
      function e() {
        (this.connected_ = !1),
          ...
          (this.refresh = Ua(this.refresh.bind(this), Da));
      }
      return (
  ...
  function Qa(e) {
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(s + i) !== t && (s -= go(n, "left", "right") + i),
        Math.round(c + a) !== r && (c -= go(n, "top", "bottom") + a)),
      !Ka(e))
    ) {
      var f = Math.round(s + i) - t,
        u = Math.round(c + a) - r;
      Math.abs(f) !== 1 && (s -= f), Math.abs(u) !== 1 && (c -= u);
    }
    return sr(o.left, o.top, s, c);
  }
  var Ya = (function () {
    return typeof SVGGraphicsElement != "undefined"
      ...
      : function (e) {
          return (
            e instanceof lt(e).SVGElement && typeof e.getBBox == "function"
          );
        };
  })();
  function Ka(e) {
  ...
  var Ja = (function () {
    ...
    Xa = (function () {
      function e(t, r) {
        var n = Ga(r);
        xo(this, { target: t, contentRect: n });
      }
      return e;
    })(),
    Za = (function () {
          ...
          if (!!this.hasActive()) {
            var t = this.callbackCtx_,
              r = this.activeObservations_.map(function (n) {
                return new Xa(n.target, n.broadcastRect());
              });
    ...
    wo = typeof WeakMap != "undefined" ? new WeakMap() : new yo(),
    Eo = (function () {
      function e(t) {
  ...
  ["observe", "unobserve", "disconnect"].forEach(function (e) {
    Eo.prototype[e] = function () {
      var t;
      return (t = wo.get(this))[e].apply(t, arguments);
    };
  });
  var es = (function () {
      return typeof ir.ResizeObserver != "undefined" ? ir.ResizeObserver : Eo;
    })(),
    Oo = es;
  var _o = new _(),
    ts = j(() =>
      P(
        new Oo((e) => {
          for (let t of e) _o.next(t);
        }),
      ),
    ).pipe(
      x((e) => A(xe, P(e)).pipe(C(() => e.disconnect()))),
      X(1),
    );
  function Ae(e) {
  ...
  function qe(e, t) {
    fr[e].checked !== t && fr[e].click();
  }
  function dt(e) {
    let t = fr[e];
    return g(t, "change").pipe(
      m(() => t.checked),
      q(t.checked),
    );
  }
  ...
  function Ao() {
    return g(window, "keydown").pipe(
      M((e) => !(e.metaKey || e.ctrlKey)),
      m((e) => ({
        mode: Lo("search") ? "search" : "global",
        type: e.key,
        claim() {
      ...
      M(({ mode: e, type: t }) => {
        if (e === "global") {
          let r = Ne();
          if (typeof r != "undefined") return !ns(r, t);
        }
        return !0;
      }),
      ne(),
  ...
  function Ro(e, t) {
    ...
    else if (Array.isArray(t)) for (let r of t) Ro(e, r);
  }
  function L(e, t, ...r) {
  ...
  function os() {
    return g(window, "hashchange").pipe(
      m(Ho),
      q(Ho()),
      M((e) => e.length > 0),
      X(1),
  ...
  function Io() {
    return os().pipe(
      m((e) => pe(`[id="${e}"]`)),
      M((e) => typeof e != "undefined"),
    );
  }
  function qr(e) {
    let t = matchMedia(e);
    return rr((r) => t.addListener(() => r(t.matches))).pipe(q(t.matches));
  }
  function $o() {
    let e = matchMedia("print");
    return A(
      g(window, "beforeprint").pipe(m(() => !0)),
      g(window, "afterprint").pipe(m(() => !1)),
    ).pipe(q(e.matches));
  }
  function Qr(e, t) {
    return e.pipe(x((r) => (r ? t() : k)));
  }
  function lr(e, t = { credentials: "same-origin" }) {
    return ie(fetch(`${e}`, t)).pipe(
      ce(() => k),
      x((r) => (r.status !== 200 ? Et(() => new Error(r.statusText)) : P(r))),
    );
  }
  function ke(e, t) {
    return lr(e, t).pipe(
  ...
  function jo(e, t) {
    ...
    return lr(e, t).pipe(
      x((n) => n.text()),
      m((n) => r.parseFromString(n, "text/xml")),
      X(1),
    );
  }
  function Fo(e) {
    let t = L("script", { src: e });
    return j(
      () => (
        ...
        A(
          g(t, "load"),
          g(t, "error").pipe(
            x(() => Et(() => new ReferenceError(`Invalid script: ${e}`))),
          ),
        ).pipe(
          m(() => {}),
  ...
  function Do() {
    return A(
      g(window, "scroll", { passive: !0 }),
      g(window, "resize", { passive: !0 }),
    ).pipe(m(Uo), q(Uo()));
  }
  function Wo() {
  ...
  function Vo() {
    return g(window, "resize", { passive: !0 }).pipe(m(Wo), q(Wo()));
  }
  function No() {
    return Y([Do(), Vo()]).pipe(
  ...
  function mr(e, { viewport$: t, header$: r }) {
    let n = t.pipe(J("size")),
      o = Y([n, r]).pipe(m(() => ze(e)));
    return Y([r, t, o]).pipe(
      m(([{ height: i }, { offset: a, size: s }, { x: c, y: f }]) => ({
        offset: { x: a.x - c, y: a.y - f + i },
        size: s,
      })),
    );
  }
  function zo(e, { tx$: t }) {
    let r = g(e, "message").pipe(m(({ data: n }) => n));
    return t.pipe(
      Mt(() => r, { leading: !0, trailing: !0 }),
      O((n) => e.postMessage(n)),
      x(() => r),
      ne(),
    );
  ...
  var is = Q("#__config"),
    ht = JSON.parse(is.textContent);
  ht.base = `${new URL(ht.base, Se())}`;
  function he() {
    return ht;
  }
  function oe(e) {
    return ht.features.includes(e);
  }
  function ee(e, t) {
    return typeof t != "undefined"
      ? ht.translations[e].replace("#", t.toString())
      : ht.translations[e];
  }
  ...
  function ae(e, t = document) {
    return B(`[data-md-component=${e}]`, t);
  }
  var ti = Ye(Kr());
  function qo(e) {
    return L(
      ...
      L(
        ...
        L("div", { class: "md-tooltip__inner md-typeset" }),
      ),
      L(
        "span",
        { class: "md-annotation__index" },
        L("span", { "data-md-annotation-id": e }),
      ),
    );
  }
  function Qo(e) {
  ...
  function Br(e, t) {
    ...
    return (
      ...
      L(
        "a",
        { href: `${i}`, class: "md-search-result__link", tabIndex: -1 },
        L(
          "article",
          {
            class: [
              "md-search-result__article",
              ...(r ? ["md-search-result__article--document"] : []),
            ].join(" "),
            "data-md-score": e.score.toFixed(2),
          },
          r > 0 && L("div", { class: "md-search-result__icon md-icon" }),
          L("h1", { class: "md-search-result__title" }, e.title),
          n > 0 &&
            e.text.length > 0 &&
            L("p", { class: "md-search-result__teaser" }, ko(e.text, 320)),
          e.tags && e.tags.map((a) => L("span", { class: "md-tag" }, a)),
          n > 0 &&
            o.length > 0 &&
            L(
              "p",
  ...
  function Yo(e) {
              ...
              L(
                ...
                L(
                  ...
                  s.length > 0 && s.length === 1
                    ...
                    : ee("search.result.more.other", s.length),
                ),
                ...s.map((f) => Br(f, 1)),
              ),
            ]
    ...
    return L("li", { class: "md-search-result__item" }, c);
  }
  function Ko(e) {
    return L(
      "ul",
  ...
  function Gr(e) {
    ...
    return L(
      "div",
      { class: t, hidden: !0 },
      L("button", { class: "tabbed-button", tabIndex: -1 }),
    );
  }
  function Bo(e) {
    return L(
      ...
      L("div", { class: "md-typeset__table" }, e),
    );
  }
  function as(e) {
    let t = he(),
    ...
    return L(
      ...
      L("a", { href: `${r}`, class: "md-version__link" }, e.title),
    );
  }
  function Go(e, t) {
    return L(
      ...
      L(
        "button",
        {
          ...
          "aria-label": ee("select.version.title"),
        },
        t.title,
      ),
      L("ul", { class: "md-version__list" }, e.map(as)),
    );
  }
  function ss(e, t) {
    let r = j(() => Y([vo(e), pt(t)])).pipe(
      m(([{ x: n, y: o }, i]) => {
        let { width: a } = Ae(e);
        return { x: n - i.x + a / 2, y: o - i.y };
      }),
    );
    return nr(e).pipe(
      x((n) =>
        r.pipe(
          m((o) => ({ active: n, offset: o })),
          re(+!n || 1 / 0),
        ),
      ),
    );
  ...
  function Jo(e, t) {
    return j(() => {
      ...
      let o = Q(":scope > :last-child", e),
        i = g(o, "mousedown", { once: !0 });
      return (
        r
          .pipe(
            x(({ active: a }) => (a ? i : k)),
            O((a) => a.preventDefault()),
          )
          .subscribe(() => e.blur()),
        ss(e, t).pipe(
          O((a) => r.next(a)),
  ...
  function cs(e) {
    let t = [];
    for (let r of B(".c, .c1, .cm", e)) {
      let n,
        o = r.firstChild;
      if (o instanceof Text)
        for (; (n = /\((\d+)\)/.exec(o.textContent)); ) {
          let i = o.splitText(n.index);
          (o = i.splitText(n[0].length)), t.push(i);
        }
    }
    return t;
  }
  ...
  function Zo(e, t, { print$: r }) {
    let n = new Map();
    for (let o of cs(t)) {
      let [, i] = o.textContent.match(/\((\d+)\)/);
      pe(`li:nth-child(${i})`, e) &&
        (n.set(+i, qo(+i)), o.replaceWith(n.get(+i)));
    }
    return n.size === 0
      ? k
      : j(() => {
          let o = new _();
          return (
            r.pipe(Z(o.pipe(fe(1)))).subscribe((i) => {
              e.hidden = !i;
              for (let [a, s] of n) {
                let c = Q(".md-typeset", s),
                  f = Q(`li:nth-child(${a})`, e);
                i ? Xo(c, f) : Xo(f, c);
              }
            }),
            A(...[...n].map(([, i]) => Jo(i, t))).pipe(
              C(() => o.complete()),
              ne(),
            )
          );
  ...
  function ri(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === "P" && !t.children.length) return ri(t);
    }
  }
  function ei(e) {
    return de(e).pipe(
      m(({ width: t }) => ({ scrollable: mt(e).width > t })),
      J("scrollable"),
    );
  }
  function ni(e, t) {
    let { matches: r } = matchMedia("(hover)"),
      n = j(() => {
        let o = new _();
        if (
          (o.subscribe(({ scrollable: a }) => {
            a && r
              ? e.setAttribute("tabindex", "0")
              : e.removeAttribute("tabindex");
          }),
          ti.default.isSupported())
        ) {
          let a = e.closest("pre");
          (a.id = `__code_${++fs}`), a.insertBefore(Qo(a.id), e);
        }
        let i = e.closest(".highlight");
        if (i instanceof HTMLElement) {
          let a = ri(i);
          if (
            typeof a != "undefined" &&
            (i.classList.contains("annotate") || oe("content.code.annotate"))
          ) {
            let s = Zo(a, e, t);
            return ei(e).pipe(
              O((c) => o.next(c)),
  ...
  function ls() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? Fo("https://unpkg.com/mermaid@9.0.1/dist/mermaid.min.js")
      : P(void 0);
  }
  function ii(e) {
    return (
      ...
      Jr ||
        (Jr = ls().pipe(
          O(() => mermaid.initialize({ startOnLoad: !1, themeCSS: oi })),
          m(() => {}),
          X(1),
        )),
      Jr.subscribe(() => {
  ...
  function ms(e, { target$: t, print$: r }) {
    let n = !0;
    return A(
      t.pipe(
        m((o) => o.closest("details:not([open])")),
        M((o) => e === o),
  ...
  var si = L("table");
  function ci(e) {
    return e.replaceWith(si), si.replaceWith(Bo(e)), P({ ref: e });
  }
  function ds(e) {
    let t = B(":scope > input", e),
      r = t.find((n) => n.checked) || t[0];
    return A(
      ...t.map((n) => g(n, "change").pipe(m(() => Q(`label[for=${n.id}]`)))),
    ).pipe(
      q(Q(`label[for=${r.id}]`)),
      m((n) => ({ active: n })),
    );
    ...
    return j(() => {
      ...
      return (
        Y([o, de(e)])
          ...
          .subscribe({
            next([{ active: a }, s]) {
              let c = ze(a),
                { width: f } = Ae(a);
              e.style.setProperty("--md-indicator-x", `${c.x}px`),
                e.style.setProperty("--md-indicator-width", `${f}px`);
              let u = or(n);
              (c.x < u.x || c.x + f > u.x + s.width) &&
                n.scrollTo({ left: Math.max(0, c.x - 16), behavior: "smooth" });
            },
            complete() {
        ...
        Y([pt(n), de(n)])
          ...
          .subscribe(([a, s]) => {
            let c = mt(n);
            (t.hidden = a.x < 16), (r.hidden = a.x > c.width - s.width - 16);
          }),
        A(g(t, "click").pipe(m(() => -1)), g(r, "click").pipe(m(() => 1)))
          .pipe(Z(i))
          .subscribe((a) => {
            let { width: s } = Ae(n);
            n.scrollBy({ left: s * a, behavior: "smooth" });
          }),
        oe("content.tabs.link") &&
          o.pipe(Le(1)).subscribe(({ active: a }) => {
            let s = a.innerText.trim();
            for (let f of B("[data-tabs]"))
              for (let u of B(":scope > input", f))
                if (Q(`label[for=${u.id}]`).innerText.trim() === s) {
                  u.click();
                  break;
                }
            let c = __md_get("__tabs") || [];
            __md_set("__tabs", [...new Set([s, ...c])]);
          }),
        ds(e).pipe(
          O((a) => o.next(a)),
          C(() => o.complete()),
  ...
  function ui(e, { target$: t, print$: r }) {
    return A(
      ...B("pre:not(.mermaid) > code", e).map((n) => ni(n, { print$: r })),
      ...B("pre.mermaid", e).map((n) => ii(n)),
      ...B("table:not([class])", e).map((n) => ci(n)),
      ...B("details", e).map((n) => ai(n, { target$: t, print$: r })),
      ...B("[data-tabs]", e).map((n) => fi(n)),
    );
  }
  function hs(e, { alert$: t }) {
    return t.pipe(
      x((r) =>
        A(P(!0), P(!1).pipe(Fe(2e3))).pipe(
          m((n) => ({ message: r, active: n })),
        ),
      ),
    );
  }
  ...
  function bs({ viewport$: e }) {
    if (!oe("header.autohide")) return P(!1);
    let t = e.pipe(
        m(({ offset: { y: o } }) => o),
        Me(2, 1),
        m(([o, i]) => [o < i, i]),
      ...
      r = Y([e, t]).pipe(
        M(([{ offset: o }, [, i]]) => Math.abs(i - o.y) > 100),
        m(([, [o]]) => o),
        K(),
      ),
      n = dt("search");
    return Y([e, n]).pipe(
      m(([{ offset: o }, i]) => o.y > 400 && !i),
      K(),
      x((o) => (o ? r : P(!1))),
      q(!1),
    );
  ...
  function li(e, t) {
    return j(() => Y([de(e), bs(t)])).pipe(
      m(([{ height: r }, n]) => ({ height: r, hidden: n })),
      K((r, n) => r.height === n.height && r.hidden === n.hidden),
      X(1),
    );
  }
  function mi(e, { header$: t, main$: r }) {
    return j(() => {
      let n = new _(),
        o = n.pipe(fe(1));
      return (
        n
          .pipe(J("active"), Je(t))
          .subscribe(([{ active: i }, { hidden: a }]) => {
            e.classList.toggle("md-header--shadow", i && !a), (e.hidden = a);
          }),
        r.subscribe(n),
        t.pipe(
          Z(o),
  ...
  function vs(e, { viewport$: t, header$: r }) {
  ...
  function hi(e, { viewport$: t, header$: r }) {
    let n = r.pipe(
        m(({ height: i }) => i),
        K(),
      ),
    ...
    return Y([n, o, t]).pipe(
      m(
        ([
          ...
          (f = Math.max(0, f - Math.max(0, a - c, i) - Math.max(0, f + c - s))),
          { offset: a - i, height: f, active: a - i <= c }
        ),
      ),
      K(
        (i, a) =>
  ...
  function vi({ alert$: e }) {
    Xr.default.isSupported() &&
      new $((t) => {
        new Xr.default("[data-clipboard-target], [data-clipboard-text]", {
          text: (r) =>
            r.getAttribute("data-clipboard-text") ||
            ys(Q(r.getAttribute("data-clipboard-target"))),
  ...
  function dr(e) {
    ...
    {
      let r = he();
      return jo(new URL("sitemap.xml", e || r.base)).pipe(
        m((n) => xs(B("loc", n).map((o) => o.textContent))),
        ce(() => k),
        je([]),
        O((n) => __md_set("__sitemap", n, sessionStorage, e)),
      );
    }
  }
  function gi({ document$: e, location$: t, viewport$: r }) {
    let n = he();
    if (location.protocol === "file:") return;
    "scrollRestoration" in history &&
      ((history.scrollRestoration = "manual"),
      g(window, "beforeunload").subscribe(() => {
        history.scrollRestoration = "auto";
      }));
    let o = pe("link[rel=icon]");
    typeof o != "undefined" && (o.href = o.href);
    let i = dr().pipe(
        m((f) => f.map((u) => `${new URL(u, n.base)}`)),
        x((f) =>
          g(document.body, "click").pipe(
            M((u) => !u.metaKey && !u.ctrlKey),
            x((u) => {
                ...
                if (p && !p.target) {
                  ...
                  if (
                    ...
                    l.pathname !== location.pathname &&
                      f.includes(l.toString()))
                  )
                    return u.preventDefault(), P({ url: new URL(p.href) });
                }
              }
              return xe;
            }),
      ...
      a = g(window, "popstate").pipe(
        M((f) => f.state !== null),
        m((f) => ({ url: new URL(location.href), offset: f.state })),
        ne(),
      );
    A(i, a)
      .pipe(
        K((f, u) => f.url.href === u.url.href),
        m(({ url: f }) => f),
      )
      .subscribe(t);
    let s = t.pipe(
      J("pathname"),
      x((f) => lr(f.href).pipe(ce(() => (ur(f), xe)))),
      ne(),
    );
    i.pipe(ut(s)).subscribe(({ url: f }) => {
      history.pushState({}, "", `${f}`);
    });
    let c = new DOMParser();
    s
      .pipe(
        x((f) => f.text()),
        m((f) => c.parseFromString(f, "text/html")),
      )
      .subscribe(e),
      e.pipe(Le(1)).subscribe((f) => {
        for (let u of [
          "title",
          "link[rel=canonical]",
          "meta[name=author]",
          ...
          ...(oe("navigation.tabs.sticky") ? ["[data-md-component=tabs]"] : []),
        ]) {
          let p = pe(u),
            l = pe(u, f);
          typeof p != "undefined" &&
      ...
      e
        .pipe(
          ...
          Ir((f) => {
            ...
            } else return (u.textContent = f.textContent), f.replaceWith(u), k;
          }),
        )
        .subscribe(),
      A(i, a)
        .pipe(ut(e))
        .subscribe(({ url: f, offset: u }) => {
          f.hash && !u
            ? Po(f.hash)
            : window.scrollTo(0, (u == null ? void 0 : u.y) || 0);
        }),
      r.pipe(Tt(i), Xe(250), J("offset")).subscribe(({ offset: f }) => {
        history.replaceState(f, "");
      }),
      A(i, a)
        .pipe(
          Me(2, 1),
          M(([f, u]) => f.url.pathname === u.url.pathname),
          m(([, f]) => f),
        )
        .subscribe(({ offset: f }) => {
  ...
  var xi = Ye(Zr());
  function en(e, t) {
    let r = new RegExp(e.separator, "img"),
  ...
  function _s({ config: e, docs: t }) {
    e.lang.length === 1 &&
      e.lang[0] === "en" &&
      (e.lang = [ee("search.config.lang")]),
      e.separator === "[\\s\\-]+" &&
        (e.separator = ee("search.config.separator"));
    let n = {
      pipeline: ee("search.config.pipeline")
        .split(/\s*,\s*/)
        .filter(Boolean),
      suggestions: oe("search.suggest"),
    };
    return { config: e, docs: t, options: n };
  }
  function Ei(e, t) {
    let r = he(),
      n = new Worker(e),
      ...
      i = zo(n, { tx$: o }).pipe(
        m((a) => {
          if (vt(a))
            for (let s of a.data.items)
              for (let c of s) c.location = `${new URL(c.location, r.base)}`;
          return a;
        }),
        ne(),
      );
    return (
      ie(t)
        .pipe(m((a) => ({ type: 0, data: _s(a) })))
        .subscribe(o.next.bind(o)),
      { tx$: o, rx$: i }
    );
  }
  function Oi({ document$: e }) {
    let t = he(),
      r = ke(new URL("../versions.json", t.base)).pipe(ce(() => k)),
      n = r.pipe(
        m((o) => {
          let [, i] = t.base.match(/([^/]+)\/?$/);
          return (
    ...
    r
      .pipe(
        m(
          (o) =>
            new Map(
              o.map((i) => [`${new URL(`../${i.version}/`, t.base)}`, i]),
            ),
        ),
        x((o) =>
          g(document.body, "click").pipe(
            M((i) => !i.metaKey && !i.ctrlKey),
            ge(n),
            x(([i, a]) => {
              if (i.target instanceof Element) {
                ...
                if (s && !s.target && o.has(s.href)) {
                  i.preventDefault();
                  let c = s.href;
                  return !i.target.closest(".md-version") && o.get(c) === a
                    ? k
                    : P(c);
                }
              }
            ...
            x((i) => {
              ...
              return dr(new URL(i)).pipe(
                m((s) => {
                  let f = Se().href.replace(t.base, "");
                  return s.includes(f)
                    ? new URL(`../${a}/${f}`, t.base)
                    : new URL(i);
                }),
      ...
      .subscribe((o) => ur(o)),
      Y([r, n]).subscribe(([o, i]) => {
        Q(".md-header__topic").appendChild(Go(o, i));
      }),
  ...
  function Ts(e, { rx$: t }) {
    let r = (__search == null ? void 0 : __search.transform) || Si,
      { searchParams: n } = Se();
    n.has("q") && qe("search", !0);
    let o = t.pipe(
      M(bt),
    ...
    dt("search")
      ...
      .subscribe(() => {
        ...
        s.searchParams.delete("q"), history.replaceState({}, "", `${s}`);
      }),
      o.subscribe((s) => {
        s && ((e.value = s), e.focus());
      });
    let i = nr(e),
      a = A(g(e, "keyup"), g(e, "focus").pipe(Fe(1)), o).pipe(
        m(() => r(e.value)),
        q(""),
        K(),
      );
    return Y([a, i]).pipe(
      m(([s, c]) => ({ value: s, focus: c })),
      X(1),
    );
  }
  function _i(e, { tx$: t, rx$: r }) {
    let n = new _(),
      o = n.pipe(fe(1));
    return (
      n
        .pipe(
          J("value"),
          m(({ value: i }) => ({ type: 2, data: i })),
        )
        .subscribe(t.next.bind(t)),
      n.pipe(J("focus")).subscribe(({ focus: i }) => {
        i
          ? (qe("search", i), (e.placeholder = ""))
          : (e.placeholder = ee("search.placeholder"));
      }),
      g(e.form, "reset")
        .pipe(Z(o))
        .subscribe(() => e.focus()),
  ...
  function Ti(e, { rx$: t }, { query$: r }) {
    let n = new _(),
      o = Mo(e.parentElement).pipe(M(Boolean)),
      i = Q(":scope > :first-child", e),
      a = Q(":scope > :last-child", e),
      s = t.pipe(M(bt), re(1));
    return (
      n.pipe(ge(r), Tt(s)).subscribe(([{ items: f }, { value: u }]) => {
        if (u)
          switch (f.length) {
            case 0:
              i.textContent = ee("search.result.none");
              break;
            case 1:
              i.textContent = ee("search.result.one");
              break;
            default:
              i.textContent = ee("search.result.other", pr(f.length));
          }
        else i.textContent = ee("search.result.placeholder");
      }),
      n
        .pipe(
          O(() => (a.innerHTML = "")),
        ...
        .subscribe((f) => a.appendChild(Yo(f))),
      t
        .pipe(
          M(vt),
          m(({ data: f }) => f),
  ...
  function Ms(e, { query$: t }) {
    return t.pipe(
      m(({ value: r }) => {
        ...
        return (
          (n.hash = ""),
          n.searchParams.delete("h"),
          n.searchParams.set("q", r),
          { url: n }
        );
      }),
    );
  ...
  function Mi(e, t) {
    ...
    return (
      ...
      g(e, "click").subscribe((n) => n.preventDefault()),
      Ms(e, t).pipe(
        O((n) => r.next(n)),
        C(() => r.complete()),
        m((n) => U({ ref: e }, n)),
  ...
  function Li(e, { rx$: t }, { keyboard$: r }) {
    let n = new _(),
      o = we("search-query"),
      i = A(g(o, "keydown"), g(o, "focus")).pipe(
        Ie(ue),
        m(() => o.value),
        K(),
      );
    return (
      n
        .pipe(
          ...
          m(([{ suggestions: s }, c]) => {
            let f = c.split(/([\s-]+)/);
            if ((s == null ? void 0 : s.length) && f[f.length - 1]) {
              let u = s[s.length - 1];
      ...
      r.pipe(M(({ mode: s }) => s === "search")).subscribe((s) => {
        switch (s.type) {
          case "ArrowRight":
            e.innerText.length &&
  ...
  function Ai(e, { index$: t, keyboard$: r }) {
    let n = he();
    try {
      let o = (__search == null ? void 0 : __search.worker) || n.search,
        i = Ei(o, t),
        a = we("search-query", e),
        s = we("search-result", e),
        { tx$: c, rx$: f } = i;
      c.pipe(M(wi), ut(f.pipe(M(bt))), re(1)).subscribe(c.next.bind(c)),
        r.pipe(M(({ mode: l }) => l === "search")).subscribe((l) => {
          let d = Ne();
          switch (l.type) {
            case "Enter":
              if (d === a) {
                let h = new Map();
                for (let b of B(":first-child [href]", s)) {
                  let F = b.firstElementChild;
                  h.set(b, parseFloat(F.getAttribute("data-md-score")));
                }
                if (h.size) {
                  let [[b]] = [...h].sort(([, F], [, G]) => G - F);
                  b.click();
                }
                l.claim();
              }
        ...
        r.pipe(M(({ mode: l }) => l === "global")).subscribe((l) => {
          switch (l.type) {
            case "f":
            case "s":
            case "/":
              a.focus(), a.select(), l.claim();
              break;
          }
        });
      let u = _i(a, i),
      ...
      return A(u, p).pipe(
        Ze(
          ...ae("search-share", e).map((l) => Mi(l, { query$: u })),
          ...ae("search-suggest", e).map((l) => Li(l, i, { keyboard$: r })),
        ),
      );
    } catch (o) {
      return (e.hidden = !0), xe;
    }
  }
  function Ci(e, { index$: t, location$: r }) {
    return Y([
      t,
      r.pipe(
        q(Se()),
        M((n) => !!n.searchParams.get("h")),
      ),
    ]).pipe(
      m(([n, o]) => en(n.config, !0)(o.searchParams.get("h"))),
      m((n) => {
        var a;
        let o = new Map(),
        ...
        for (let s = i.nextNode(); s; s = i.nextNode())
          if ((a = s.parentElement) != null && a.offsetHeight) {
            let c = s.textContent,
              f = n(c);
            f.length > c.length && o.set(s, f);
          }
        for (let [s, c] of o) {
          let { childNodes: f } = L("span", null, c);
          s.replaceWith(...Array.from(f));
        }
        return { ref: e, nodes: o };
      }),
    );
  }
  function Ls(e, { viewport$: t, main$: r }) {
  ...
  function tn(e, n) {
    ...
    return j(() => {
      let s = new _();
      return (
        s.pipe($e(0, Te), ge(t)).subscribe({
          next([{ height: c }, { height: f }]) {
            (i.style.height = `${c - 2 * a}px`), (e.style.top = `${f}px`);
          },
          complete() {
  ...
  function Ri(e, t) {
    if (typeof t != "undefined") {
      ...
      return Ot(
        ke(`${r}/releases/latest`).pipe(
          ce(() => k),
          m((n) => ({ version: n.tag_name })),
          je({}),
        ),
        ke(r).pipe(
          ce(() => k),
          m((n) => ({ stars: n.stargazers_count, forks: n.forks_count })),
          je({}),
        ),
      ).pipe(m(([n, o]) => U(U({}, n), o)));
    } else {
      ...
      return ke(r).pipe(
        m((n) => ({ repositories: n.public_repos })),
        je({}),
      );
    }
  }
  function ki(e, t) {
    ...
    return ke(r).pipe(
      ce(() => k),
      m(({ star_count: n, forks_count: o }) => ({ stars: n, forks: o })),
      je({}),
    );
  }
  function Hi(e) {
  ...
  function Cs(e) {
    return (
      ...
      (As = j(() => {
        ...
        return t
          ? P(t)
          : Hi(e.href).pipe(O((r) => __md_set("__source", r, sessionStorage)));
      }).pipe(
        ce(() => k),
        M((t) => Object.keys(t).length > 0),
        m((t) => ({ facts: t })),
        X(1),
      ))
    );
  ...
  function Rs(e, { viewport$: t, header$: r }) {
    return de(document.body).pipe(
      x(() => mr(e, { header$: r, viewport$: t })),
      m(({ offset: { y: n } }) => ({ hidden: n >= 10 })),
      J("hidden"),
    );
  }
  function Ii(e, t) {
    return j(() => {
      ...
      return (
        ...
        (oe("navigation.tabs.sticky") ? P({ hidden: !1 }) : Rs(e, t)).pipe(
          O((n) => r.next(n)),
          C(() => r.complete()),
          m((n) => U({ ref: e }, n)),
        )
  ...
  function ks(e, { viewport$: t, header$: r }) {
    let n = new Map(),
      o = B("[href^=\\#]", e);
    for (let s of o) {
      let c = decodeURIComponent(s.hash.substring(1)),
        f = pe(`[id="${c}"]`);
      typeof f != "undefined" && n.set(s, f);
    }
    let i = r.pipe(
      J("height"),
      m(({ height: s }) => {
        let c = we("main"),
          f = Q(":scope > :first-child", c);
        return s + 0.8 * (f.offsetTop - c.offsetTop);
      }),
      ne(),
    );
    return de(document.body)
          ...
          j(() => {
            ...
            return P(
              [...n].reduce((f, [u, p]) => {
                for (
                  ;
                  c.length && n.get(c[c.length - 1]).tagName >= p.tagName;

                )
                  c.pop();
                let l = p.offsetTop;
                for (; !l && p.parentElement; )
                  (p = p.parentElement), (l = p.offsetTop);
                return f.set([...(c = [...c, u])].reverse(), l);
              }, new Map()),
            );
          }).pipe(
            m((c) => new Map([...c].sort(([, f], [, u]) => f - u))),
            Je(i),
            x(([c, f]) =>
              t.pipe(
                Fr(
                  ([u, p], { offset: { y: l }, size: d }) => {
                    let h = l + d.height >= Math.floor(s.height);
                    for (; p.length; ) {
                      let [, b] = p[0];
                      if (b - f < l || h) u = [...u, p.shift()];
                      else break;
                    }
                    for (; u.length; ) {
                      let [, b] = u[u.length - 1];
                      if (b - f >= l && !h) p = [u.pop(), ...p];
                      else break;
                    }
                    return [u, p];
                  },
      ...
      .pipe(
        m(([s, c]) => ({ prev: s.map(([f]) => f), next: c.map(([f]) => f) })),
        q({ prev: [], next: [] }),
        Me(2, 1),
        m(([s, c]) =>
          s.prev.length < c.prev.length
            ? {
                prev: c.prev.slice(
            ...
            : {
                prev: c.prev.slice(-1),
                next: c.next.slice(0, c.next.length - s.next.length),
              },
        ),
      );
  }
  function $i(e, { viewport$: t, header$: r, target$: n }) {
    return j(() => {
      let o = new _(),
        i = o.pipe(fe(1));
      return (
        o.subscribe(({ prev: a, next: s }) => {
          for (let [c] of s)
            c.classList.remove("md-nav__link--passed"),
              c.classList.remove("md-nav__link--active");
          for (let [c, [f]] of a.entries())
            f.classList.add("md-nav__link--passed"),
              f.classList.toggle("md-nav__link--active", c === a.length - 1);
        }),
        oe("navigation.tracking") &&
          t
            .pipe(
              Z(i),
              J("offset"),
            ...
            .subscribe(([, { prev: a }]) => {
              ...
              if (c && c.length) {
                let [f] = c,
                  { hash: u } = new URL(f.href);
                s.hash !== u &&
                  ((s.hash = u), history.replaceState({}, "", `${s}`));
              } else (s.hash = ""), history.replaceState({}, "", `${s}`);
            }),
        ks(e, { viewport$: t, header$: r }).pipe(
          O((a) => o.next(a)),
          C(() => o.complete()),
          m((a) => U({ ref: e }, a)),
        )
  ...
  function Hs(e, { viewport$: t, main$: r, target$: n }) {
    let o = t.pipe(
        m(({ offset: { y: a } }) => a),
        Me(2, 1),
        m(([a, s]) => a > s && s > 0),
  ...
  function ji(e, { viewport$: t, header$: r, main$: n, target$: o }) {
    let i = new _(),
      a = i.pipe(fe(1));
    return (
      i.subscribe({
      ...
      r.pipe(Z(a), J("height")).subscribe(({ height: s }) => {
        e.style.top = `${s + 16}px`;
      }),
      Hs(e, { viewport$: t, main$: n, target$: o }).pipe(
        O((s) => i.next(s)),
        C(() => i.complete()),
        m((s) => U({ ref: e }, s)),
      )
  ...
  function Fi({ document$: e, tablet$: t }) {
    e.pipe(
      x(() => B(".md-toggle--indeterminate, [data-md-state=indeterminate]")),
      O((r) => {
  ...
  function Ui({ document$: e }) {
    e.pipe(
      x(() => B("[data-md-scrollfix]")),
      O((t) => t.removeAttribute("data-md-scrollfix")),
      M(Ps),
      se((t) => g(t, "touchstart").pipe(m(() => t))),
    ).subscribe((t) => {
      let r = t.scrollTop;
      r === 0
        ? (t.scrollTop = 1)
  ...
  function Di({ viewport$: e, tablet$: t }) {
    Y([dt("search"), t])
      .pipe(
        m(([r, n]) => r && !n),
        x((r) => P(r).pipe(Fe(r ? 400 : 100))),
        ge(e),
      )
      .subscribe(
        ([
  ...
  var et = bo(),
    ...
    rn = Ao(),
    Ee = No(),
    vr = qr("(min-width: 960px)"),
    Vi = qr("(min-width: 1220px)"),
    Ni = $o(),
    zi = he(),
    qi = document.forms.namedItem("search")
      ? (__search == null ? void 0 : __search.index) ||
        ke(new URL("search/search_index.json", zi.base))
      : xe,
    nn = new _();
  vi({ alert$: nn });
  oe("navigation.instant") &&
    gi({ document$: et, location$: br, viewport$: Ee });
  var Wi;
  ((Wi = zi.version) == null ? void 0 : Wi.provider) === "mike" &&
    Oi({ document$: et });
  A(br, At)
    .pipe(Fe(125))
    .subscribe(() => {
      qe("drawer", !1), qe("search", !1);
    });
  rn.pipe(M(({ mode: e }) => e === "global")).subscribe((e) => {
    switch (e.type) {
      case "p":
      case ",":
        let t = pe("[href][rel=prev]");
        typeof t != "undefined" && t.click();
        break;
      case "n":
      case ".":
        let r = pe("[href][rel=next]");
        typeof r != "undefined" && r.click();
        break;
    }
  });
  Fi({ document$: et, tablet$: vr });
  Ui({ document$: et });
  Di({ viewport$: Ee, tablet$: vr });
  var Qe = li(we("header"), { viewport$: Ee }),
    hr = et.pipe(
      m(() => we("main")),
      x((e) => hi(e, { viewport$: Ee, header$: Qe })),
      X(1),
    ),
    Is = A(
      ...ae("dialog").map((e) => pi(e, { alert$: nn })),
      ...ae("header").map((e) =>
        mi(e, { viewport$: Ee, header$: Qe, main$: hr }),
      ),
      ...ae("palette").map((e) => bi(e)),
      ...ae("search").map((e) => Ai(e, { index$: qi, keyboard$: rn })),
      ...ae("source").map((e) => Pi(e)),
    ),
    $s = j(() =>
      A(
        ...ae("content").map((e) => ui(e, { target$: At, print$: Ni })),
        ...ae("content").map((e) =>
          oe("search.highlight") ? Ci(e, { index$: qi, location$: br }) : k,
        ),
        ...ae("header-title").map((e) => di(e, { viewport$: Ee, header$: Qe })),
        ...ae("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? Qr(Vi, () => tn(e, { viewport$: Ee, header$: Qe, main$: hr }))
            : Qr(vr, () => tn(e, { viewport$: Ee, header$: Qe, main$: hr })),
        ),
        ...ae("tabs").map((e) => Ii(e, { viewport$: Ee, header$: Qe })),
        ...ae("toc").map((e) =>
          $i(e, { viewport$: Ee, header$: Qe, target$: At }),
        ),
        ...ae("top").map((e) =>
          ji(e, { viewport$: Ee, header$: Qe, main$: hr, target$: At }),
        ),
      ),
    ),
    Qi = et.pipe(
