  ...
  return function (e) {
    ...
    (e.ar = function () {
      this.pipeline.reset(),
        ...
        this.searchPipeline &&
          (this.searchPipeline.reset(), this.searchPipeline.add(e.ar.stemmer));
    }),
      ...
      (e.ar.stemmer = (function () {
        ...
        return (
          ...
          (e.stem = function () {
            var r = 0;
            for (
              e.result = !1, e.preRemoved = !1, e.sufRemoved = !1;
              r < e.execArray.length && 1 != e.result;
          ...
          (e.cleanWord = function () {
            ...
            return (e.word = e.word.replace("ـ", "")), !!r.test("");
          }),
          (e.removeDiacritics = function () {
            new RegExp("[ً-ٛ]");
            return (e.word = e.word.replace(/[\u064b-\u065b]/gi, "")), !1;
          }),
          (e.cleanAlef = function () {
            var r = new RegExp("[آأإٱى]");
            return (e.word = e.word.replace(r, "ا")), !1;
          }),
          ...
          (e.removeEndTaa = function () {
            return (
              !(e.word.length > 2) ||
              ((e.word = e.word.replace(/[\u0627]$/, "")),
              (e.word = e.word.replace("ة", "")),
              !1)
            );
          }),
          ...
          (e.removePre432 = function () {
            ...
            return r != e.word && (e.preRemoved = !0), !1;
          }),
              ...
              if (1 == c) {
                if (r[t].mPt) {
                  for (var p = [], m = 0; m < r[t].mPt.length; m++)
                    null != r[t].mPt[m].m
                      ? (p[r[t].mPt[m].l] = e.word[r[t].mPt[m].m])
                      : (p[r[t].mPt[m].l] = r[t].mPt[m].c);
                  e.word = p.join("");
                }
                e.result = !0;
                break;
          ...
          (e.removeSuf1 = function () {
            ...
            return r != e.word && (e.sufRemoved = !0), !1;
          }),
          ...
          (e.wordCheck = function () {
            for (
              var r = (e.word, [e.removeSuf432, e.removeSuf1, e.removePre1]),
                t = 0,
                c = !1;
              e.word.length >= 7 && !e.result && t < r.length;

            )
              7 != e.word.length || c
                ? (r[t](), t++, (c = !1))
                : (e.checkPattern73(), (c = !0));
            var l = [
              e.checkPattern63,
              e.removeSuf432,
              e.removeSuf1,
          ...
          function (r) {
            return "function" == typeof r.update
              ? r.update(function (r) {
                  return e.setCurrent(r), e.stem(), e.getCurrent();
                })
