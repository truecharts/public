  ...
  return function (e) {
    ...
    (e.es = function () {
      ...
      (e.es.stemmer = (function () {
        var s = e.stemmerSupport.Among,
          r = e.stemmerSupport.SnowballProgram,
          n = new (function () {
            function e() {
              if (A.out_grouping(x, 97, 252)) {
            ...
            function n() {
              if (A.in_grouping(x, 97, 252)) {
                var s = A.cursor;
                if (e()) {
                  if (((A.cursor = s), !A.in_grouping(x, 97, 252))) return !0;
            ...
            function i() {
              var s,
                r = A.cursor;
              if (n()) {
                if (((A.cursor = r), !A.out_grouping(x, 97, 252))) return;
                if (((s = A.cursor), e())) {
                  if (
                    ((A.cursor = s),
                    !A.in_grouping(x, 97, 252) || A.cursor >= A.limit)
                  )
                    return;
                  A.cursor++;
                }
            ...
            function t() {
              ...
              (g = A.limit),
                ...
                i(),
                (A.cursor = e),
                a() && ((p = A.cursor), a() && (v = A.cursor));
            }
            function o() {
              for (var e; ; ) {
                if (((A.bra = A.cursor), (e = A.find_among(k, 6))))
                  switch (((A.ket = A.cursor), e)) {
                    case 1:
                      A.slice_from("a");
                      continue;
                    case 2:
            ...
            function m() {
              ...
              if (
                ((A.ket = A.cursor),
                A.find_among_b(y, 13) &&
                  ((A.bra = A.cursor), (e = A.find_among_b(q, 11)) && u()))
              )
                switch (e) {
                  case 1:
                    (A.bra = A.cursor), A.slice_from("iendo");
                    break;
                  case 2:
                    (A.bra = A.cursor), A.slice_from("ando");
                    break;
                  case 3:
                    (A.bra = A.cursor), A.slice_from("ar");
                    break;
                  case 4:
                    (A.bra = A.cursor), A.slice_from("er");
                    break;
                  case 5:
                    (A.bra = A.cursor), A.slice_from("ir");
                    break;
                  case 6:
                    A.slice_del();
                    break;
            ...
            function l(e, s) {
              ...
              var r = A.find_among_b(e, s);
              return (
                r && ((A.bra = A.cursor), 1 == r && c() && A.slice_del()), !1
              );
            }
            function d(e) {
              return (
                ...
                (A.slice_del(),
                (A.ket = A.cursor),
                A.eq_s_b(2, e) && ((A.bra = A.cursor), c() && A.slice_del()),
                !1)
              );
            }
            function b() {
              var e;
              if (((A.ket = A.cursor), (e = A.find_among_b(S, 46)))) {
            ...
            function f() {
              ...
              if (
                ...
                (A.limit_backward = g),
                (A.ket = A.cursor),
                (e = A.find_among_b(W, 12)),
                (A.limit_backward = s),
                e)
              ) {
                if (((A.bra = A.cursor), 1 == e)) {
                  if (!A.eq_s_b(1, "u")) return !1;
                  A.slice_del();
                }
                return !0;
              }
            ...
            function h() {
              var e, s;
              if (((A.ket = A.cursor), (e = A.find_among_b(z, 8))))
                switch (((A.bra = A.cursor), e)) {
                  case 1:
                    u() && A.slice_del();
                    break;
                  case 2:
                    u() &&
                      ...
                      A.eq_s_b(1, "u") &&
                        ...
                        (s = A.limit - A.cursor),
                        A.eq_s_b(1, "g") &&
                          ((A.cursor = A.limit - s), u() && A.slice_del())));
                }
            }
            var v,
              p,
            ...
            (this.setCurrent = function (e) {
              ...
              (this.stem = function () {
                ...
                return (
                  ...
                  (A.cursor = A.limit),
                  b() ||
                    ((A.cursor = A.limit), f() || ((A.cursor = A.limit), _())),
                  (A.cursor = A.limit),
                  h(),
