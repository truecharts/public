          ...
          i = new (function () {
            function e(e, r, n) {
              return (
                !(
                  !x.eq_s(1, e) ||
                  ((x.ket = x.cursor), !x.in_grouping(L, 97, 249))
                ) && (x.slice_from(r), (x.cursor = n), !0)
              );
            }
            function i() {
              for (var r, n, i, o, t = x.cursor; ; ) {
                if (((x.bra = x.cursor), (r = x.find_among(h, 7))))
                  switch (((x.ket = x.cursor), r)) {
                    case 1:
                      x.slice_from("à");
                      continue;
                    case 2:
              ...
              for (x.cursor = t; ; )
                for (n = x.cursor; ; ) {
                  if (((i = x.cursor), x.in_grouping(L, 97, 249))) {
                    if (((x.bra = x.cursor), (o = x.cursor), e("u", "U", i)))
                      break;
                    if (((x.cursor = o), e("i", "I", i))) break;
                  }
                  if (((x.cursor = i), x.cursor >= x.limit))
                    return void (x.cursor = n);
                  x.cursor++;
                }
            }
            function o(e) {
              if (((x.cursor = e), !x.in_grouping(L, 97, 249))) return !1;
              for (; !x.out_grouping(L, 97, 249); ) {
            ...
            function t() {
              if (x.in_grouping(L, 97, 249)) {
                var e = x.cursor;
                if (x.out_grouping(L, 97, 249)) {
                  for (; !x.in_grouping(L, 97, 249); ) {
                    if (x.cursor >= x.limit) return o(e);
                    x.cursor++;
                  }
                  return !0;
                }
            ...
            function s() {
              var e,
                r = x.cursor;
              if (!t()) {
                if (((x.cursor = r), !x.out_grouping(L, 97, 249))) return;
                if (((e = x.cursor), x.out_grouping(L, 97, 249))) {
                  for (; !x.in_grouping(L, 97, 249); ) {
                    if (x.cursor >= x.limit)
                      return (
                        (x.cursor = e),
                        void (
                          x.in_grouping(L, 97, 249) &&
                          x.cursor < x.limit &&
                          x.cursor++
                        )
                      );
                  ...
                  return void (k = x.cursor);
                }
                if (
                  ((x.cursor = e),
                  !x.in_grouping(L, 97, 249) || x.cursor >= x.limit)
                )
                  return;
                x.cursor++;
              }
            ...
            function u() {
              ...
              (k = x.limit),
                ...
                s(),
                (x.cursor = e),
                a() && ((p = x.cursor), a() && (g = x.cursor));
            }
            function c() {
              for (var e; ; ) {
                if (((x.bra = x.cursor), !(e = x.find_among(q, 3)))) break;
            ...
            function f() {
              ...
              if (
                ((x.ket = x.cursor),
                x.find_among_b(C, 37) &&
                  ((x.bra = x.cursor), (e = x.find_among_b(z, 5)) && w()))
              )
                switch (e) {
                  case 1:
                    x.slice_del();
            ...
            function v() {
              var e;
              if (((x.ket = x.cursor), !(e = x.find_among_b(S, 51)))) return !1;
              switch (((x.bra = x.cursor), e)) {
                ...
                case 8:
                  ...
                  x.slice_del(),
                    (x.ket = x.cursor),
                    (e = x.find_among_b(F, 3)),
                    e && ((x.bra = x.cursor), 1 == e && m() && x.slice_del());
                  break;
                case 9:
                  if (!m()) return !1;
                  x.slice_del(),
            ...
            function b() {
              ...
              x.cursor >= k &&
                ...
                (x.limit_backward = k),
                (x.ket = x.cursor),
                (e = x.find_among_b(W, 87)),
                e && ((x.bra = x.cursor), 1 == e && x.slice_del()),
                (x.limit_backward = r));
            }
            function d() {
              ...
              if (
                ((x.ket = x.cursor),
                x.in_grouping_b(y, 97, 242) &&
                  ((x.bra = x.cursor),
                  w() &&
                    (x.slice_del(),
                    (x.ket = x.cursor),
                    x.eq_s_b(1, "i") && ((x.bra = x.cursor), w()))))
              )
                return void x.slice_del();
              x.cursor = x.limit - e;
            }
            function _() {
              d(),
                ...
                x.eq_s_b(1, "h") &&
                  ((x.bra = x.cursor),
                  x.in_grouping_b(U, 99, 103) && w() && x.slice_del());
            }
            var g,
              p,
              k,
              ...
              q = [new r("", -1, 3), new r("I", 0, 1), new r("U", 0, 2)],
              C = [
                new r("la", -1, -1),
                new r("cela", 0, -1),
                new r("gliela", 0, -1),
