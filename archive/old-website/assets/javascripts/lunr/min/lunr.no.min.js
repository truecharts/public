        ...
        var r = e.stemmerSupport.Among,
          ...
          i = new (function () {
            function e() {
              var e,
                r = w.cursor + 3;
              if (((a = w.limit), 0 <= r || r <= w.limit)) {
                for (s = r; ; ) {
                  if (((e = w.cursor), w.in_grouping(d, 97, 248))) {
                    w.cursor = e;
                    break;
                  }
                  if (e >= w.limit) return;
            ...
            function i() {
              ...
              if (
                ...
                switch (((w.bra = w.cursor), e)) {
                  ...
                  case 2:
                    (n = w.limit - w.cursor),
                      w.in_grouping_b(c, 98, 122)
                        ? w.slice_del()
                        : ((w.cursor = w.limit - n),
                          w.eq_s_b(1, "k") &&
                            w.out_grouping_b(d, 97, 248) &&
                            w.slice_del());
                    break;
                  case 3:
                    w.slice_from("er");
