          ...
          i = new (function () {
            function e(e, r, n) {
              return (
                !(
                  !v.eq_s(1, e) ||
                  ((v.ket = v.cursor), !v.in_grouping(p, 97, 252))
                ) && (v.slice_from(r), (v.cursor = n), !0)
              );
            }
            function i() {
              for (var r, n, i, s, t = v.cursor; ; )
                if (((r = v.cursor), (v.bra = r), v.eq_s(1, "ß")))
                  (v.ket = v.cursor), v.slice_from("ss");
                else {
                  if (r >= v.limit) break;
                  v.cursor = r + 1;
                }
              for (v.cursor = t; ; )
                for (n = v.cursor; ; ) {
                  if (((i = v.cursor), v.in_grouping(p, 97, 252))) {
                    if (((s = v.cursor), (v.bra = s), e("u", "U", i))) break;
                    if (((v.cursor = s), e("y", "Y", i))) break;
                  }
                  if (i >= v.limit) return void (v.cursor = n);
                  v.cursor = i + 1;
                }
            }
            function s() {
              for (; !v.in_grouping(p, 97, 252); ) {
                if (v.cursor >= v.limit) return !0;
                v.cursor++;
              }
              for (; !v.out_grouping(p, 97, 252); ) {
                if (v.cursor >= v.limit) return !0;
                v.cursor++;
              }
              return !1;
            ...
            function t() {
              ...
              0 <= e &&
                ...
                ((d = e),
                s() ||
                  ((m = v.cursor), m < d && (m = d), s() || (l = v.cursor)));
            }
            function o() {
              for (var e, r; ; ) {
                if (((r = v.cursor), (v.bra = r), !(e = v.find_among(h, 6))))
                  return;
            ...
            function a() {
              ...
              if (
                ((v.ket = v.cursor),
                (e = v.find_among_b(w, 7)) && ((v.bra = v.cursor), c()))
              )
                switch (e) {
                  case 1:
                    v.slice_del();
                  ...
                  case 2:
                    v.slice_del(),
                      ...
                      v.eq_s_b(1, "s") &&
                        ((v.bra = v.cursor),
                        v.eq_s_b(3, "nis") && v.slice_del());
                    break;
                  case 3:
                    v.in_grouping_b(g, 98, 116) && v.slice_del();
                }
              if (
                ((v.cursor = v.limit - s),
                (v.ket = v.cursor),
                (e = v.find_among_b(f, 4)) && ((v.bra = v.cursor), c()))
              )
                switch (e) {
                  case 1:
                    v.slice_del();
                    break;
                  case 2:
                    if (v.in_grouping_b(k, 98, 116)) {
                      var t = v.cursor - 3;
                      v.limit_backward <= t &&
                        t <= v.limit &&
                        ((v.cursor = t), v.slice_del());
                    }
                }
              if (
                ((v.cursor = v.limit - s),
                (v.ket = v.cursor),
                (e = v.find_among_b(_, 8)) && ((v.bra = v.cursor), u()))
              )
                switch (e) {
                  case 1:
                    v.slice_del(),
                      ...
                      v.eq_s_b(2, "ig") &&
                        ...
                        (r = v.limit - v.cursor),
                        v.eq_s_b(1, "e") ||
                          ((v.cursor = v.limit - r), u() && v.slice_del()));
                    break;
                  case 2:
                    (n = v.limit - v.cursor),
                      v.eq_s_b(1, "e") ||
                        ((v.cursor = v.limit - n), v.slice_del());
                    break;
                  case 3:
                    if (
                      (v.slice_del(),
                      ...
                      (i = v.limit - v.cursor),
                      !v.eq_s_b(2, "er") &&
                        ((v.cursor = v.limit - i), !v.eq_s_b(2, "en")))
                    )
                      break;
                    (v.bra = v.cursor), c() && v.slice_del();
                    break;
                  case 4:
                    v.slice_del(),
                      (v.ket = v.cursor),
                      (e = v.find_among_b(b, 2)),
                      e && ((v.bra = v.cursor), u() && 1 == e && v.slice_del());
                }
            }
            var d,
              l,
