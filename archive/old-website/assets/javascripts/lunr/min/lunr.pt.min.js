      ...
      (e.pt.stemmer = (function () {
        var r = e.stemmerSupport.Among,
          ...
          n = new (function () {
            function e() {
              for (var e; ; ) {
                if (((z.bra = z.cursor), (e = z.find_among(k, 3))))
                  switch (((z.ket = z.cursor), e)) {
                    case 1:
                      z.slice_from("a~");
                      continue;
                    case 2:
            ...
            function n() {
              if (z.out_grouping(y, 97, 250)) {
                for (; !z.in_grouping(y, 97, 250); ) {
            ...
            function i() {
              if (z.in_grouping(y, 97, 250))
                for (; !z.out_grouping(y, 97, 250); ) {
                  if (z.cursor >= z.limit) return !1;
                  z.cursor++;
                }
              return (g = z.cursor), !0;
            }
            function o() {
              ...
              if (z.in_grouping(y, 97, 250))
                if (((e = z.cursor), n())) {
                  if (((z.cursor = e), i())) return;
                } else g = z.cursor;
              if (((z.cursor = s), z.out_grouping(y, 97, 250))) {
                if (((r = z.cursor), n())) {
                  if (
                    ((z.cursor = r),
                    !z.in_grouping(y, 97, 250) || z.cursor >= z.limit)
                  )
                    return;
                  z.cursor++;
                }
            ...
            function a() {
              ...
              (g = z.limit),
                ...
                o(),
                (z.cursor = e),
                t() && ((b = z.cursor), t() && (h = z.cursor));
            }
            function u() {
              for (var e; ; ) {
                if (((z.bra = z.cursor), (e = z.find_among(q, 3))))
                  switch (((z.ket = z.cursor), e)) {
                    case 1:
                      z.slice_from("ã");
                      continue;
            ...
            function l() {
              var e;
              if (((z.ket = z.cursor), !(e = z.find_among_b(F, 45)))) return !1;
              switch (((z.bra = z.cursor), e)) {
                case 1:
                  if (!c()) return !1;
                  z.slice_del();
                  break;
                    ...
                    e &&
                      ...
                      c() &&
                        ...
                        1 == e &&
                          ((z.ket = z.cursor),
                          z.eq_s_b(2, "at") &&
                            ((z.bra = z.cursor), c() && z.slice_del()))));
                  break;
                case 6:
                  if (!c()) return !1;
                  z.slice_del(),
                    (z.ket = z.cursor),
                    (e = z.find_among_b(C, 3)),
                    e && ((z.bra = z.cursor), 1 == e && c() && z.slice_del());
                  break;
                case 7:
                  if (!c()) return !1;
                  z.slice_del(),
                    (z.ket = z.cursor),
                    (e = z.find_among_b(P, 3)),
                    e && ((z.bra = z.cursor), 1 == e && c() && z.slice_del());
                  break;
                case 8:
                  if (!c()) return !1;
            ...
            function d() {
              var e;
              (z.ket = z.cursor),
                (e = z.find_among_b(W, 7)) &&
                  ((z.bra = z.cursor), 1 == e && w() && z.slice_del());
            }
            function v(e, r) {
              if (z.eq_s_b(1, e)) {
                z.bra = z.cursor;
                var s = z.limit - z.cursor;
                if (z.eq_s_b(1, r))
                  return (z.cursor = z.limit - s), w() && z.slice_del(), !1;
              }
              return !0;
            }
            function p() {
              var e;
              if (((z.ket = z.cursor), (e = z.find_among_b(L, 4))))
                switch (((z.bra = z.cursor), e)) {
                  case 1:
                    w() &&
                      (z.slice_del(),
            ...
            function _() {
              if (!l() && ((z.cursor = z.limit), !f()))
                return (z.cursor = z.limit), void d();
              (z.cursor = z.limit),
                (z.ket = z.cursor),
                z.eq_s_b(1, "i") &&
                  ((z.bra = z.cursor),
                  z.eq_s_b(1, "c") &&
                    ((z.cursor = z.limit), w() && z.slice_del()));
            }
            var h,
              b,
              g,
              k = [new r("", -1, 3), new r("ã", 0, 1), new r("õ", 0, 2)],
              q = [new r("", -1, 3), new r("a~", 0, 1), new r("o~", 0, 2)],
              j = [
                new r("ic", -1, -1),
                new r("ad", -1, -1),
                new r("os", -1, -1),
