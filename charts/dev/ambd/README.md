...
Automated MusicBrainz Downloader :: This script will automatically archive music using a popular online DL Client

TrueCharts can be installed as both *normal* Helm Charts or as Apps on TrueNAS SCALE.

This readme is just an automatically generated general guide on installing our Helm Charts and Apps.
For more information, please click here: [ambd](https://truecharts.org/charts/stable/ambd)
...
To install the chart with the release name `ambd`

```console
helm repo add TrueCharts https://helm.truecharts.org
helm repo update
helm install ambd TrueCharts/ambd
```
...
To uninstall the `ambd` deployment
...
```console
helm install ambd TrueCharts/ambd -f values.yaml
```
