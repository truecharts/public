...
Automated Music Archiver :: This script will automatically archive music using a popular online DL Client

TrueCharts can be installed as both *normal* Helm Charts or as Apps on TrueNAS SCALE.

This readme is just an automatically generated general guide on installing our Helm Charts and Apps.
For more information, please click here: [ama](https://truecharts.org/charts/stable/ama)
...
To install the chart with the release name `ama`

```console
helm repo add TrueCharts https://helm.truecharts.org
helm repo update
helm install ama TrueCharts/ama
```
...
To uninstall the `ama` deployment
...
```console
helm install ama TrueCharts/ama -f values.yaml
```
