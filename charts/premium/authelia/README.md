...
`helm install mychart oci://tccr.io/truecharts/authelia`
...
The most recent version of which, is available here: https://github.com/truecharts/public/blob/master/charts/premium/authelia/values.yaml
