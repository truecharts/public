...
For more information, please click here: [shadowsocks](https://truecharts.org/docs/charts/incubator/shadowsocks)
...
To install the chart with the release name `shadowsocks`
...
To uninstall the `shadowsocks` deployment

```console
helm uninstall shadowsocks
```
...
```console
helm install shadowsocks TrueCharts/shadowsocks -f values.yaml
```
