...
![Version: 0.0.1](https://img.shields.io/badge/Version-0.0.1-informational?style=flat-square) ![AppVersion: 0.3.57](https://img.shields.io/badge/AppVersion-0.3.57-informational?style=flat-square)
...
helm repo update
helm install homepage TrueCharts/homepage
```
...
To uninstall the `homepage` deployment
...
```console
helm install homepage TrueCharts/homepage -f values.yaml
```
