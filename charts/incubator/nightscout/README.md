...
For more information, please click here: [nightscout](https://truecharts.org/docs/charts/incubator/nightscout)
...
helm repo update
helm install nightscout TrueCharts/nightscout
```
...
```console
helm install nightscout TrueCharts/nightscout -f values.yaml
```
