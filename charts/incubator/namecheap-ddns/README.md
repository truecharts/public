...
This simple container will update a namecheap dynamic dns domain. You must set an 'A + Dynamic DNS Record' for the host and enable Dynamic DNS in the manage page for your domain.

TrueCharts can be installed as both *normal* Helm Charts or as Apps on TrueNAS SCALE.

This readme is just an automatically generated general guide on installing our Helm Charts and Apps.
For more information, please click here: [namecheap-ddns](https://truecharts.org/docs/charts/incubator/namecheap-ddns)
...
To install the chart with the release name `namecheap-ddns`
...
To uninstall the `namecheap-ddns` deployment

```console
helm uninstall namecheap-ddns
```
...
```console
helm install namecheap-ddns TrueCharts/namecheap-ddns -f values.yaml
```
