...
For more information, please click here: [tubesync](https://truecharts.org/docs/charts/incubator/tubesync)
...
To install the chart with the release name `tubesync`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install tubesync TrueCharts/tubesync
```
...
To uninstall the `tubesync` deployment

```console
helm uninstall tubesync
```
...
```console
helm install tubesync TrueCharts/tubesync -f values.yaml
```
