...
For more information, please click here: [sinusbot](https://truecharts.org/docs/charts/incubator/sinusbot)
...
```console
helm install sinusbot TrueCharts/sinusbot -f values.yaml
```
