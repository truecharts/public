...
For more information, please click here: [trango](https://truecharts.org/docs/charts/incubator/trango)
...
To install the chart with the release name `trango`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install trango TrueCharts/trango
```
...
To uninstall the `trango` deployment

```console
helm uninstall trango
```
...
```console
helm install trango TrueCharts/trango -f values.yaml
```
