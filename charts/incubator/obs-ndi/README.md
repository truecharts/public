...
For more information, please click here: [obs-ndi](https://truecharts.org/docs/charts/incubator/obs-ndi)
...
To install the chart with the release name `obs-ndi`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install obs-ndi TrueCharts/obs-ndi
```
...
To uninstall the `obs-ndi` deployment

```console
helm uninstall obs-ndi
```
...
```console
helm install obs-ndi TrueCharts/obs-ndi -f values.yaml
```
