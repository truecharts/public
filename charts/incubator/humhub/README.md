...
For more information, please click here: [humhub](https://truecharts.org/docs/charts/incubator/humhub)
...
To install the chart with the release name `humhub`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install humhub TrueCharts/humhub
```
...
To uninstall the `humhub` deployment

```console
helm uninstall humhub
```
...
```console
helm install humhub TrueCharts/humhub -f values.yaml
```
