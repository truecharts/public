...
`helm install mychart oci://tccr.io/truecharts/teslamate`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/incubator/teslamate/values.yaml
