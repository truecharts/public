...
For more information, please click here: [preclear](https://truecharts.org/docs/charts/incubator/preclear)
...
To uninstall the `preclear` deployment

```console
helm uninstall preclear
```
