...
`helm install mychart oci://tccr.io/truecharts/kapowarr`
...
The most recent version of which, is available here: https://github.com/truecharts/public/blob/master/charts/incubator/kapowarr/values.yaml
