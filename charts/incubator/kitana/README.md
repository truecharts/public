...
For more information, please click here: [kitana](https://truecharts.org/docs/charts/incubator/kitana)
...
To install the chart with the release name `kitana`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install kitana TrueCharts/kitana
```
...
To uninstall the `kitana` deployment

```console
helm uninstall kitana
```
...
```console
helm install kitana TrueCharts/kitana -f values.yaml
```
