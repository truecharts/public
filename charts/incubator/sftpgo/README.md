...
For more information, please click here: [sftpgo](https://truecharts.org/docs/charts/incubator/sftpgo)
...
To install the chart with the release name `sftpgo`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install sftpgo TrueCharts/sftpgo
```
...
To uninstall the `sftpgo` deployment

```console
helm uninstall sftpgo
```
...
```console
helm install sftpgo TrueCharts/sftpgo -f values.yaml
```
