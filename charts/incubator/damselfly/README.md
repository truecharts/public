...
For more information, please click here: [damselfly](https://truecharts.org/docs/charts/incubator/damselfly)
...
To install the chart with the release name `damselfly`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install damselfly TrueCharts/damselfly
```
...
To uninstall the `damselfly` deployment

```console
helm uninstall damselfly
```
...
```console
helm install damselfly \
  --set env.TZ="America/New York" \
    TrueCharts/damselfly
```
...
```console
helm install damselfly TrueCharts/damselfly -f values.yaml
```
