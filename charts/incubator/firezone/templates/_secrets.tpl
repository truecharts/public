...
{{- $keyGuardian := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
{{- $keyDatabase := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
{{- $keySecret := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
{{- $keyLive := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
{{- $keyCookieSigning := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
{{- $keyCookieEncrypt := (printf "base64:%v" (randAlphaNum 32 | b64enc)) -}}
