...
For more information, please click here: [goaccess](https://truecharts.org/docs/charts/incubator/goaccess)
...
To install the chart with the release name `goaccess`

```console
helm repo add TrueCharts https://charts.truecharts.org
helm repo update
helm install goaccess TrueCharts/goaccess
```
...
To uninstall the `goaccess` deployment

```console
helm uninstall goaccess
```
...
```console
helm install goaccess TrueCharts/goaccess -f values.yaml
```
