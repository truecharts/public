...
`helm install mychart oci://tccr.io/truecharts/pvk-ii`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pvk-ii/values.yaml
