...
`helm install mychart oci://tccr.io/truecharts/go-playground`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/go-playground/values.yaml
