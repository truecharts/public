...
`helm install mychart oci://tccr.io/truecharts/actualserver`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/actualserver/values.yaml
