...
`helm install mychart oci://tccr.io/truecharts/tandoor-recipes`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/tandoor-recipes/values.yaml
