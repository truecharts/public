...
`helm install mychart oci://tccr.io/truecharts/soft-serve`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/soft-serve/values.yaml
