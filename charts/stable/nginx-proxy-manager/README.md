...
`helm install mychart oci://tccr.io/truecharts/nginx-proxy-manager`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/nginx-proxy-manager/values.yaml
