...
`helm install mychart oci://tccr.io/truecharts/gaseous-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/gaseous-server/values.yaml
