...
`helm install mychart oci://tccr.io/truecharts/restic-rest-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/restic-rest-server/values.yaml
