...
`helm install mychart oci://tccr.io/truecharts/paperless-ngx`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/paperless-ngx/values.yaml
