...
`helm install mychart oci://tccr.io/truecharts/thunderbird`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/thunderbird/values.yaml
