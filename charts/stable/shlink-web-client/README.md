...
`helm install mychart oci://tccr.io/truecharts/shlink-web-client`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/shlink-web-client/values.yaml
