...
`helm install mychart oci://tccr.io/truecharts/rustpad`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rustpad/values.yaml
