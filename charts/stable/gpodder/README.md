...
`helm install mychart oci://tccr.io/truecharts/gpodder`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/gpodder/values.yaml
