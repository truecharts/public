...
`helm install mychart oci://tccr.io/truecharts/emby-sync`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/emby-sync/values.yaml
