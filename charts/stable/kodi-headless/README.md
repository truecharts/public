...
`helm install mychart oci://tccr.io/truecharts/kodi-headless`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/kodi-headless/values.yaml
