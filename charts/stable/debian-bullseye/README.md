...
`helm install mychart oci://tccr.io/truecharts/debian-bullseye`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/debian-bullseye/values.yaml
