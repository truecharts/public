...
`helm install mychart oci://tccr.io/truecharts/namecheap-ddns`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/namecheap-ddns/values.yaml
