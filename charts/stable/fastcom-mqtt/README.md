...
`helm install mychart oci://tccr.io/truecharts/fastcom-mqtt`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/fastcom-mqtt/values.yaml
