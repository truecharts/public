...
`helm install mychart oci://tccr.io/truecharts/emulatorjs`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/emulatorjs/values.yaml
