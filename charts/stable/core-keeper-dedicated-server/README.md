...
`helm install mychart oci://tccr.io/truecharts/core-keeper-dedicated-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/core-keeper-dedicated-server/values.yaml
