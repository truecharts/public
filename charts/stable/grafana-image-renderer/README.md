...
`helm install mychart oci://tccr.io/truecharts/grafana-image-renderer`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/grafana-image-renderer/values.yaml
