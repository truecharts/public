...
`helm install mychart oci://tccr.io/truecharts/phoronix-test-suite`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/phoronix-test-suite/values.yaml
