...
![Version: 4.0.79](https://img.shields.io/badge/Version-4.0.79-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.59.0](https://img.shields.io/badge/AppVersion-0.59.0-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | kube-state-metrics | 3.2.1 |
| https://charts.bitnami.com/bitnami | node-exporter | 3.1.1 |
