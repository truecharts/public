...
`helm install mychart oci://tccr.io/truecharts/kdenlive-vnc`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/kdenlive-vnc/values.yaml
