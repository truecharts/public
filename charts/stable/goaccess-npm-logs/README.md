...
`helm install mychart oci://tccr.io/truecharts/goaccess-npm-logs`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/goaccess-npm-logs/values.yaml
