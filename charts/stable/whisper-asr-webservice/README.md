...
`helm install mychart oci://tccr.io/truecharts/whisper-asr-webservice`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/whisper-asr-webservice/values.yaml
