...
`helm install mychart oci://tccr.io/truecharts/virt-manager`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/virt-manager/values.yaml
