...
`helm install mychart oci://tccr.io/truecharts/homarr`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/homarr/values.yaml
