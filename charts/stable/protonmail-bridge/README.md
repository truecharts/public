...
`helm install mychart oci://tccr.io/truecharts/protonmail-bridge`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/protonmail-bridge/values.yaml
