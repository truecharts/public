...
`helm install mychart oci://tccr.io/truecharts/speedtest-exporter`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/speedtest-exporter/values.yaml
