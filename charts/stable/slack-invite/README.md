...
`helm install mychart oci://tccr.io/truecharts/slack-invite`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/slack-invite/values.yaml
