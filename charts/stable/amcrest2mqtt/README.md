...
`helm install mychart oci://tccr.io/truecharts/amcrest2mqtt`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/amcrest2mqtt/values.yaml
