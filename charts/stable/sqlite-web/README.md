...
`helm install mychart oci://tccr.io/truecharts/sqlite-web`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/sqlite-web/values.yaml
