...
`helm install mychart oci://tccr.io/truecharts/wg-easy`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/wg-easy/values.yaml
