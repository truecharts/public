...
`helm install mychart oci://tccr.io/truecharts/s3backup`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/s3backup/values.yaml
