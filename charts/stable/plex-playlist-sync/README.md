...
`helm install mychart oci://tccr.io/truecharts/plex-playlist-sync`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/plex-playlist-sync/values.yaml
