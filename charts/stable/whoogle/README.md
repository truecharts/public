...
`helm install mychart oci://tccr.io/truecharts/whoogle`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/whoogle/values.yaml
