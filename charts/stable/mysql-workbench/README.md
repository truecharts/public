...
`helm install mychart oci://tccr.io/truecharts/mysql-workbench`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/mysql-workbench/values.yaml
