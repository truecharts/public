...
`helm install mychart oci://tccr.io/truecharts/booksonic-air`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/booksonic-air/values.yaml
