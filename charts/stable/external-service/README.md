...
`helm install mychart oci://tccr.io/truecharts/external-service`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/external-service/values.yaml
