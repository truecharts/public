...
`helm install mychart oci://tccr.io/truecharts/minecraft-bedrock`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/minecraft-bedrock/values.yaml
