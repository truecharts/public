...
`helm install mychart oci://tccr.io/truecharts/smtp-relay`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/smtp-relay/values.yaml
