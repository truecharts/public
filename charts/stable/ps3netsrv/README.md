...
`helm install mychart oci://tccr.io/truecharts/ps3netsrv`
...
The most recent version of which, is available here: https://github.com/truecharts/public/blob/master/charts/incubator/ps3netsrv/values.yaml
