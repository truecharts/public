...
`helm install mychart oci://tccr.io/truecharts/ispy-agent-dvr`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/ispy-agent-dvr/values.yaml
