...
`helm install mychart oci://tccr.io/truecharts/zwavejs2mqtt`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/zwavejs2mqtt/values.yaml
