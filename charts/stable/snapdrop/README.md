...
`helm install mychart oci://tccr.io/truecharts/snapdrop`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/snapdrop/values.yaml
