...
`helm install mychart oci://tccr.io/truecharts/simply-shorten`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/simply-shorten/values.yaml
