...
`helm install mychart oci://tccr.io/truecharts/adguardhome-sync`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/adguardhome-sync/values.yaml
