...
`helm install mychart oci://tccr.io/truecharts/vocechat-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/vocechat-server/values.yaml
