...
`helm install mychart oci://tccr.io/truecharts/v-rising`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/v-rising/values.yaml
