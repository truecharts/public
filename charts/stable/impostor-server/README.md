...
`helm install mychart oci://tccr.io/truecharts/impostor-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/impostor-server/values.yaml
