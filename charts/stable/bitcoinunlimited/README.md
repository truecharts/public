...
`helm install mychart oci://tccr.io/truecharts/bitcoinunlimited`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/bitcoinunlimited/values.yaml
