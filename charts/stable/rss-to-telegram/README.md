...
`helm install mychart oci://tccr.io/truecharts/rss-to-telegram`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rss-to-telegram/values.yaml
