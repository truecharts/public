...
`helm install mychart oci://tccr.io/truecharts/guide2go`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/guide2go/values.yaml
