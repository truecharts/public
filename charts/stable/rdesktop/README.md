...
`helm install mychart oci://tccr.io/truecharts/rdesktop`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rdesktop/values.yaml
