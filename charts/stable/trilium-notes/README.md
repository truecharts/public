...
`helm install mychart oci://tccr.io/truecharts/trilium-notes`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/trilium-notes/values.yaml
