...
`helm install mychart oci://tccr.io/truecharts/tt-rss`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/tt-rss/values.yaml
