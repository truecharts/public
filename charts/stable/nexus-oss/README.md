...
`helm install mychart oci://tccr.io/truecharts/nexus-oss`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/nexus-oss/values.yaml
