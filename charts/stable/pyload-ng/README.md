...
`helm install mychart oci://tccr.io/truecharts/pyload-ng`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pyload-ng/values.yaml
