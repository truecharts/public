...
`helm install mychart oci://tccr.io/truecharts/synctube`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/synctube/values.yaml
