...
`helm install mychart oci://tccr.io/truecharts/haste-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/haste-server/values.yaml
