...
`helm install mychart oci://tccr.io/truecharts/pt-helper`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pt-helper/values.yaml
