...
`helm install mychart oci://tccr.io/truecharts/blender`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/blender/values.yaml
