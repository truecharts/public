...
`helm install mychart oci://tccr.io/truecharts/resilio-sync`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/resilio-sync/values.yaml
