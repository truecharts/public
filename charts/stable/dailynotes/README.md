...
`helm install mychart oci://tccr.io/truecharts/dailynotes`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/dailynotes/values.yaml
