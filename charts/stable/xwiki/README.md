...
`helm install mychart oci://tccr.io/truecharts/xwiki`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/xwiki/values.yaml
