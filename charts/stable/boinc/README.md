...
`helm install mychart oci://tccr.io/truecharts/boinc`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/boinc/values.yaml
