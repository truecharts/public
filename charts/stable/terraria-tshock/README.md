...
`helm install mychart oci://tccr.io/truecharts/terraria-tshock`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/terraria-tshock/values.yaml
