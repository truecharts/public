...
`helm install mychart oci://tccr.io/truecharts/cadquery-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/cadquery-server/values.yaml
