...
`helm install mychart oci://tccr.io/truecharts/shoko-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/shoko-server/values.yaml
