...
`helm install mychart oci://tccr.io/truecharts/prusaslicer-novnc`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/prusaslicer-novnc/values.yaml
