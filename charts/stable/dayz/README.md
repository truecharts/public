...
`helm install mychart oci://tccr.io/truecharts/dayz`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/dayz/values.yaml
