...
`helm install mychart oci://tccr.io/truecharts/citadel-forgedwithfire`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/citadel-forgedwithfire/values.yaml
