...
`helm install mychart oci://tccr.io/truecharts/americasarmy-pg`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/americasarmy-pg/values.yaml
