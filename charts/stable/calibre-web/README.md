...
`helm install mychart oci://tccr.io/truecharts/calibre-web`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/calibre-web/values.yaml
