...
`helm install mychart oci://tccr.io/truecharts/pocketmine-mp`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pocketmine-mp/values.yaml
