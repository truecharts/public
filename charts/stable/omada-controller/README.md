...
`helm install mychart oci://tccr.io/truecharts/omada-controller`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/omada-controller/values.yaml
