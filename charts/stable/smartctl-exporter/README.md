...
`helm install mychart oci://tccr.io/truecharts/smartctl-exporter`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/smartctl-exporter/values.yaml
