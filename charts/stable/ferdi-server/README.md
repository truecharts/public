...
`helm install mychart oci://tccr.io/truecharts/ferdi-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/ferdi-server/values.yaml
