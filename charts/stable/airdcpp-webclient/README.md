...
`helm install mychart oci://tccr.io/truecharts/airdcpp-webclient`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/airdcpp-webclient/values.yaml
