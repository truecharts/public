...
`helm install mychart oci://tccr.io/truecharts/dizquetv`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/dizquetv/values.yaml
