...
`helm install mychart oci://tccr.io/truecharts/electrum`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/electrum/values.yaml
