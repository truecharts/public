...
`helm install mychart oci://tccr.io/truecharts/archiveteam-warrior`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/archiveteam-warrior/values.yaml
