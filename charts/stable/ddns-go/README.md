...
`helm install mychart oci://tccr.io/truecharts/ddns-go`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/ddns-go/values.yaml
