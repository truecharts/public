...
`helm install mychart oci://tccr.io/truecharts/universal-media-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/universal-media-server/values.yaml
