...
`helm install mychart oci://tccr.io/truecharts/airsonic-advanced`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/airsonic-advanced/values.yaml
