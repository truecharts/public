...
`helm install mychart oci://tccr.io/truecharts/rflood`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rflood/values.yaml
