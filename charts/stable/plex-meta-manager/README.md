...
`helm install mychart oci://tccr.io/truecharts/plex-meta-manager`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/plex-meta-manager/values.yaml
