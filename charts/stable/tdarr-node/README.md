...
`helm install mychart oci://tccr.io/truecharts/tdarr-node`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/tdarr-node/values.yaml
