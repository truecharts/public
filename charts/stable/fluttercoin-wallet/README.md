...
`helm install mychart oci://tccr.io/truecharts/fluttercoin-wallet`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/fluttercoin-wallet/values.yaml
