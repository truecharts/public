...
`helm install mychart oci://tccr.io/truecharts/valetudo-mapper`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/valetudo-mapper/values.yaml
