...
`helm install mychart oci://tccr.io/truecharts/redis`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/redis/values.yaml
