...
`helm install mychart oci://tccr.io/truecharts/nntp2nntp`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/nntp2nntp/values.yaml
