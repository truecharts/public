...
`helm install mychart oci://tccr.io/truecharts/double-take`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/double-take/values.yaml
