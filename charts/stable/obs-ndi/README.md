...
`helm install mychart oci://tccr.io/truecharts/obs-ndi`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/obs-ndi/values.yaml
