...
`helm install mychart oci://tccr.io/truecharts/it-tools`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/it-tools/values.yaml
