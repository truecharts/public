...
`helm install mychart oci://tccr.io/truecharts/invitarr`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/invitarr/values.yaml
