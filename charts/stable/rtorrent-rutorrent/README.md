...
`helm install mychart oci://tccr.io/truecharts/rtorrent-rutorrent`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rtorrent-rutorrent/values.yaml
