...
`helm install mychart oci://tccr.io/truecharts/monero-node`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/monero-node/values.yaml
