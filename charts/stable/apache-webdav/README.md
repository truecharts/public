...
`helm install mychart oci://tccr.io/truecharts/apache-webdav`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/apache-webdav/values.yaml
