...
`helm install mychart oci://tccr.io/truecharts/steam-headless`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/steam-headless/values.yaml
