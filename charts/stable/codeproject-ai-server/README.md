...
`helm install mychart oci://tccr.io/truecharts/codeproject-ai-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/codeproject-ai-server/values.yaml
