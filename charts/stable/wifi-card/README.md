...
`helm install mychart oci://tccr.io/truecharts/wifi-card`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/wifi-card/values.yaml
