...
`helm install mychart oci://tccr.io/truecharts/browserless-chrome`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/browserless-chrome/values.yaml
