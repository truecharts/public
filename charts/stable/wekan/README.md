...
`helm install mychart oci://tccr.io/truecharts/wekan`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/wekan/values.yaml
