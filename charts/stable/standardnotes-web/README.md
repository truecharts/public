...
`helm install mychart oci://tccr.io/truecharts/standardnotes-web`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/standardnotes-web/values.yaml
