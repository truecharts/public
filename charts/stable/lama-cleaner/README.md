...
`helm install mychart oci://tccr.io/truecharts/lama-cleaner`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/lama-cleaner/values.yaml
