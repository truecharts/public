...
`helm install mychart oci://tccr.io/truecharts/pgadmin`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pgadmin/values.yaml
