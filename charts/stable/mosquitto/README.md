...
`helm install mychart oci://tccr.io/truecharts/mosquitto`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/mosquitto/values.yaml
