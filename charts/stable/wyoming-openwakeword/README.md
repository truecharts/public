...
`helm install mychart oci://tccr.io/truecharts/wyoming-openwakeword`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/wyoming-openwakeword/values.yaml
