...
`helm install mychart oci://tccr.io/truecharts/owi2plex`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/owi2plex/values.yaml
