...
`helm install mychart oci://tccr.io/truecharts/rcon-webadmin`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/rcon-webadmin/values.yaml
