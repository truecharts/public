...
`helm install mychart oci://tccr.io/truecharts/local-ai`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/local-ai/values.yaml
