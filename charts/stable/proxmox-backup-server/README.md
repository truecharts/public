...
`helm install mychart oci://tccr.io/truecharts/proxmox-backup-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/proxmox-backup-server/values.yaml
