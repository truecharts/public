...
`helm install mychart oci://tccr.io/truecharts/appdaemon`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/appdaemon/values.yaml
