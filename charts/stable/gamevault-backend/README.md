...
`helm install mychart oci://tccr.io/truecharts/gamevault-backend`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/gamevault-backend/values.yaml
