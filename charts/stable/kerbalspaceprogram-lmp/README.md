...
`helm install mychart oci://tccr.io/truecharts/kerbalspaceprogram-lmp`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/kerbalspaceprogram-lmp/values.yaml
