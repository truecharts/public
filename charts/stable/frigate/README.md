...
`helm install mychart oci://tccr.io/truecharts/frigate`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/frigate/values.yaml
