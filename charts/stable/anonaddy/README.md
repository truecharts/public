...
`helm install mychart oci://tccr.io/truecharts/anonaddy`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/anonaddy/values.yaml
