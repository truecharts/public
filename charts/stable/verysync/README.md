...
`helm install mychart oci://tccr.io/truecharts/verysync`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/verysync/values.yaml
