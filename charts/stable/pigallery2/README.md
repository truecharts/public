...
`helm install mychart oci://tccr.io/truecharts/pigallery2`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pigallery2/values.yaml
