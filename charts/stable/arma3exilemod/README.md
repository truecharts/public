...
`helm install mychart oci://tccr.io/truecharts/arma3exilemod`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/arma3exilemod/values.yaml
