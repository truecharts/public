...
`helm install mychart oci://tccr.io/truecharts/vlmcsd-kms-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/vlmcsd-kms-server/values.yaml
