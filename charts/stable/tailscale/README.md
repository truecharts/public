...
`helm install mychart oci://tccr.io/truecharts/tailscale`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/tailscale/values.yaml
