...
`helm install mychart oci://tccr.io/truecharts/anope`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/anope/values.yaml
