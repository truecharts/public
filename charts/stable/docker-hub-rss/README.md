...
`helm install mychart oci://tccr.io/truecharts/docker-hub-rss`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/docker-hub-rss/values.yaml
