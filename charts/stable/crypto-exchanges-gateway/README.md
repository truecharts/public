...
`helm install mychart oci://tccr.io/truecharts/crypto-exchanges-gateway`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/crypto-exchanges-gateway/values.yaml
