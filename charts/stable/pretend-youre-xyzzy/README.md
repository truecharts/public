...
`helm install mychart oci://tccr.io/truecharts/pretend-youre-xyzzy`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/pretend-youre-xyzzy/values.yaml
