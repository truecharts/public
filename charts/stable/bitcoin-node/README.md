...
`helm install mychart oci://tccr.io/truecharts/bitcoin-node`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/bitcoin-node/values.yaml
