...
`helm install mychart oci://tccr.io/truecharts/nvidia-gpu-exporter`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/nvidia-gpu-exporter/values.yaml
