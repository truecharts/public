...
`helm install mychart oci://tccr.io/truecharts/kerio-connect`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/kerio-connect/values.yaml
