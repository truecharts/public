...
`helm install mychart oci://tccr.io/truecharts/dns-doh-companion`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/dns-doh-companion/values.yaml
