...
`helm install mychart oci://tccr.io/truecharts/traggo`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/traggo/values.yaml
