...
`helm install mychart oci://tccr.io/truecharts/tsn-ranksystem`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/tsn-ranksystem/values.yaml
