...
`helm install mychart oci://tccr.io/truecharts/krusader`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/krusader/values.yaml
