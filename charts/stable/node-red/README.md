...
`helm install mychart oci://tccr.io/truecharts/node-red`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/node-red/values.yaml
