...
`helm install mychart oci://tccr.io/truecharts/firefox-syncserver`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/firefox-syncserver/values.yaml
