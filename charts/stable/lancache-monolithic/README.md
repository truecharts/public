...
`helm install mychart oci://tccr.io/truecharts/lancache-monolithic`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/lancache-monolithic/values.yaml
