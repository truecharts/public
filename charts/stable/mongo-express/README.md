...
`helm install mychart oci://tccr.io/truecharts/mongo-express`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/mongo-express/values.yaml
