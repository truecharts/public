...
`helm install mychart oci://tccr.io/truecharts/teamspeak3`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/teamspeak3/values.yaml
