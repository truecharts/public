...
`helm install mychart oci://tccr.io/truecharts/modsecurity-crs`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/modsecurity-crs/values.yaml
