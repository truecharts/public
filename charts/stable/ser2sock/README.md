...
`helm install mychart oci://tccr.io/truecharts/ser2sock`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/ser2sock/values.yaml
