...
`helm install mychart oci://tccr.io/truecharts/convos`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/convos/values.yaml
