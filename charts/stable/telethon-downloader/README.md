...
`helm install mychart oci://tccr.io/truecharts/telethon-downloader`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/telethon-downloader/values.yaml
