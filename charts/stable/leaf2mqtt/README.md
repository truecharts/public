...
`helm install mychart oci://tccr.io/truecharts/leaf2mqtt`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/leaf2mqtt/values.yaml
