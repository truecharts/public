...
`helm install mychart oci://tccr.io/truecharts/neverwinternights-ee`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/neverwinternights-ee/values.yaml
