...
`helm install mychart oci://tccr.io/truecharts/traefik-forward-auth`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/traefik-forward-auth/values.yaml
