...
`helm install mychart oci://tccr.io/truecharts/automatic-ripping-machine`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/automatic-ripping-machine/values.yaml
