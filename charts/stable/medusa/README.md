...
`helm install mychart oci://tccr.io/truecharts/medusa`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/medusa/values.yaml
