...
`helm install mychart oci://tccr.io/truecharts/garrysmod`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/garrysmod/values.yaml
