...
`helm install mychart oci://tccr.io/truecharts/st-reborn-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/st-reborn-server/values.yaml
