...
`helm install mychart oci://tccr.io/truecharts/xen-orchestra`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/xen-orchestra/values.yaml
