...
`helm install mychart oci://tccr.io/truecharts/filebot`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/filebot/values.yaml
