...
`helm install mychart oci://tccr.io/truecharts/game-server-watcher`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/game-server-watcher/values.yaml
