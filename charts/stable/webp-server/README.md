...
`helm install mychart oci://tccr.io/truecharts/webp-server`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/webp-server/values.yaml
