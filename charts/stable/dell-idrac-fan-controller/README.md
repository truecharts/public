...
`helm install mychart oci://tccr.io/truecharts/dell-idrac-fan-controller`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/dell-idrac-fan-controller/values.yaml
