...
`helm install mychart oci://tccr.io/truecharts/breitbandmessung-de`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/breitbandmessung-de/values.yaml
