...
`helm install mychart oci://tccr.io/truecharts/photo-stream`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/photo-stream/values.yaml
