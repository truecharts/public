...
Once this is done you can successful add Ingress using the steps outlined inside our [Quick-Start Guide](https://truecharts.org/manual/Quick-Start%20Guides/09-add-ingress/). If you require more help or details please refer to our Discord for help from our Support Staff.
