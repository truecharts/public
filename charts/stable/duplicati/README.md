...
`helm install mychart oci://tccr.io/truecharts/duplicati`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/stable/duplicati/values.yaml
