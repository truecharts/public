...
`helm install mychart oci://tccr.io/truecharts/kubelet-csr-approver`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/system/kubelet-csr-approver/values.yaml
