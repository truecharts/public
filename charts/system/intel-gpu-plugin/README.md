...
`helm install mychart oci://tccr.io/truecharts/intel-gpu-plugin`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/system/intel-gpu-plugin/values.yaml
