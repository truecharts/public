...
`helm install mychart oci://tccr.io/truecharts/kubernetes-reflector`
...
The most recent version of which, is available here: https://github.com/truecharts/charts/blob/master/charts/system/kubernetes-reflector/values.yaml
