...
if [[ -d "charts/${1}" ]]; then
    ...
    helm dependency dependency "charts/${1}" --skip-refresh || (sleep 10 && helm dependency dependency "charts/${1}" --skip-refresh) || (sleep 10 && helm dependency dependency "charts/${1}" --skip-refresh)
